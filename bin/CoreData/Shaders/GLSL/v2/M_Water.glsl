...
void main()
{
    ...
    half NoV = clamp(dot(surfaceData.normal, surfaceData.eyeVec), 0.0, 1.0);
        ...
        half4 reflectedColor = Indirect_PBRWater(surfaceData.reflectionColor0.rgb, surfaceData.specular, NoV);
    #else
        half4 reflectedColor = Indirect_SimpleWater(surfaceData.reflectionColor0.rgb, cMatEnvMapColor, NoV);
    #endif
#else
