...
function (vs_generate_sln SLN_PATH)
    ...
    file(APPEND "${SLN_PATH}" "\t\tRelease|Any CPU = Release|Any CPU\r\n")
    file(APPEND "${SLN_PATH}" "\t\tMinSizeRel|Any CPU = MinSizeRel|Any CPU\r\n")
    file(APPEND "${SLN_PATH}" "\t\tRelWithDebInfo|Any CPU = RelWithDebInfo|Any CPU\r\n")
    file(APPEND "${SLN_PATH}" "\t\tDebug|Any CPU = Debug|Any CPU\r\n")
    ...
    foreach (ARG ${ARGN})
        ...
        if (is_csproj GREATER -1)
            ...
            file(APPEND "${SLN_PATH}" "\t\t{${arg_guid}}.Release|Any CPU.ActiveCfg = Release|Any CPU\r\n")
            file(APPEND "${SLN_PATH}" "\t\t{${arg_guid}}.Release|Any CPU.Build.0 = Release|Any CPU\r\n")
            file(APPEND "${SLN_PATH}" "\t\t{${arg_guid}}.MinSizeRel|Any CPU.ActiveCfg = MinSizeRel|Any CPU\r\n")
            file(APPEND "${SLN_PATH}" "\t\t{${arg_guid}}.MinSizeRel|Any CPU.Build.0 = MinSizeRel|Any CPU\r\n")
            file(APPEND "${SLN_PATH}" "\t\t{${arg_guid}}.RelWithDebInfo|Any CPU.ActiveCfg = RelWithDebInfo|Any CPU\r\n")
            file(APPEND "${SLN_PATH}" "\t\t{${arg_guid}}.RelWithDebInfo|Any CPU.Build.0 = RelWithDebInfo|Any CPU\r\n")
            file(APPEND "${SLN_PATH}" "\t\t{${arg_guid}}.Debug|Any CPU.ActiveCfg = Debug|Any CPU\r\n")
            file(APPEND "${SLN_PATH}" "\t\t{${arg_guid}}.Debug|Any CPU.Build.0 = Debug|Any CPU\r\n")
        endif ()
    endforeach ()
    file(APPEND "${SLN_PATH}" "\tEndGlobalSection\r\n")
