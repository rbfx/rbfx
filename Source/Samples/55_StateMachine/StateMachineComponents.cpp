...
bool ProjectNMetaData::LoadXML(const Urho3D::XMLElement& source)
{
    ...
    while (compElem)
    {
        ea::string name = compElem.GetAttribute("name");
        ea::string value = compElem.GetAttribute("value");
        ...
        if (name == "groundPathClickable") {
            ...
            _gameObjectType = atoi(value.c_str());
        }
...
void ProjectNMetaData::setRoofVisible(bool visible, ea::map<Urho3D::SharedPtr<Urho3D::Material>, Urho3D::SharedPtr<Urho3D::Material>> &roofMaterials, ea::map<Urho3D::SharedPtr<Urho3D::Technique>, Urho3D::SharedPtr<Urho3D::Technique>> &roofTechniques)
{
...
GameSceneObject::GameSceneObject(const ea::string &objectId, int objectType)
:_objectId(objectId)
