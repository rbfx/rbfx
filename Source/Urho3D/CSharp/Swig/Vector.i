...
%template(ComponentRefList)                 eastl::vector<eastl::shared_ptr<Urho3D::Component>>;
...
%template(NodeRefList)                      eastl::vector<eastl::shared_ptr<Urho3D::Node>>;
...
%template(UIElementRefList)                 eastl::vector<eastl::shared_ptr<Urho3D::UIElement>>;
...
%template(VertexBufferRefList)              eastl::vector<eastl::shared_ptr<Urho3D::VertexBuffer>>;
%template(IndexBufferList)                  eastl::vector<Urho3D::IndexBuffer*>;
%template(IndexBufferRefList)               eastl::vector<eastl::shared_ptr<Urho3D::IndexBuffer>>;
...
%template(PackageFileList)                  eastl::vector<eastl::shared_ptr<Urho3D::PackageFile>>;
%template(Texture2DList)                    eastl::vector<eastl::shared_ptr<Urho3D::Texture2D>>;
%template(ComponentVector2)                 eastl::vector<eastl::weak_ptr<Urho3D::Component>>;
//%template(VAnimKeyFrameList)              eastl::vector<Urho3D::VAnimKeyFrame>; // some issue with const
%template(GeometryList)                     eastl::vector<eastl::shared_ptr<Urho3D::Geometry>>;
//%template(ConnectionList)                 eastl::vector<eastl::shared_ptr<Urho3D::Connection>>;
%template(GeometriesList)                   eastl::vector<eastl::vector<eastl::shared_ptr<Urho3D::Geometry>>>;
...
%template(AnimationStateList)               eastl::vector<eastl::shared_ptr<Urho3D::AnimationState>>;
...
%template(ShaderVariationList)              eastl::vector<eastl::shared_ptr<Urho3D::ShaderVariation>>;
