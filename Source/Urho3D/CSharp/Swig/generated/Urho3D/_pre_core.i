...
//%csattribute(Urho3D::Variant, %arg(Urho3D::VariantType), Type, GetType);
%csattribute(Urho3D::Variant, %arg(ea::string), TypeName, GetTypeName);
%csattribute(Urho3D::Variant, %arg(bool), Zero, IsZero);
...
//%csattribute(Urho3D::TypeInfo, %arg(Urho3D::StringHash), Type, GetType);
...
//%csattribute(Urho3D::ObjectFactory, %arg(Urho3D::StringHash), Type, GetType);
...
%csattribute(Urho3D::Context, %arg(ea::unordered_map<StringHash, SharedPtr<ObjectFactory>>), ObjectFactories, GetObjectFactories);
%csattribute(Urho3D::Context, %arg(ea::unordered_map<ea::string, ea::vector<StringHash>>), ObjectCategories, GetObjectCategories);
...
%csattribute(Urho3D::Context, %arg(ea::unordered_map<StringHash, ea::vector<AttributeInfo>>), AllAttributes, GetAllAttributes);
...
%csattribute(Urho3D::StopToken, %arg(bool), Stopped, IsStopped);
...
%csattribute(Urho3D::WorkQueue, %arg(bool), Completing, IsCompleting);
