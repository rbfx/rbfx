...
%constant eastl::string CategoryAudio = "Component/Audio";
%ignore Urho3D::Category_Audio;
%constant eastl::string CategoryGeometry = "Component/Geometry";
%ignore Urho3D::Category_Geometry;
%constant eastl::string CategoryIk = "Component/Inverse Kinematics";
%ignore Urho3D::Category_IK;
%constant eastl::string CategoryLogic = "Component/Logic";
%ignore Urho3D::Category_Logic;
%constant eastl::string CategoryNavigation = "Component/Navigation";
%ignore Urho3D::Category_Navigation;
%constant eastl::string CategoryPhysics = "Component/Physics";
%ignore Urho3D::Category_Physics;
%constant eastl::string CategoryPhysics2d = "Component/Physics2D";
%ignore Urho3D::Category_Physics2D;
%constant eastl::string CategoryRmlui = "Component/RmlUI";
%ignore Urho3D::Category_RmlUI;
%constant eastl::string CategoryScene = "Component/Scene";
%ignore Urho3D::Category_Scene;
%constant eastl::string CategorySubsystem = "Component/Subsystem";
%ignore Urho3D::Category_Subsystem;
%constant eastl::string CategoryUrho2d = "Component/Urho2D";
%ignore Urho3D::Category_Urho2D;
%constant eastl::string CategoryUi = "UI";
