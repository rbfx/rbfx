...
%csattribute(Urho3D::PhysicsWorld, %arg(bool), UpdateEnabled, IsUpdateEnabled, SetUpdateEnabled);
...
%csattribute(Urho3D::PhysicsWorld, %arg(bool), ApplyingTransforms, IsApplyingTransforms, SetApplyingTransforms);
%csattribute(Urho3D::PhysicsWorld, %arg(bool), Simulating, IsSimulating);
...
%csattribute(Urho3D::RigidBody, %arg(bool), Kinematic, IsKinematic, SetKinematic);
%csattribute(Urho3D::RigidBody, %arg(bool), Trigger, IsTrigger, SetTrigger);
%csattribute(Urho3D::RigidBody, %arg(bool), Active, IsActive);
