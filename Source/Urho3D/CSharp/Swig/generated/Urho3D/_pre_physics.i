...
%csattribute(Urho3D::PhysicsWorld, %arg(Vector3), Gravity, GetGravity, SetGravity);
...
%csattribute(Urho3D::PhysicsWorld, %arg(CollisionGeometryDataCache), TriMeshCache, GetTriMeshCache);
%csattribute(Urho3D::PhysicsWorld, %arg(CollisionGeometryDataCache), ConvexCache, GetConvexCache);
%csattribute(Urho3D::PhysicsWorld, %arg(CollisionGeometryDataCache), GImpactTrimeshCache, GetGImpactTrimeshCache);
...
%csattribute(Urho3D::CollisionShape, %arg(CollisionGeometryData *), GeometryData, GetGeometryData);
%csattribute(Urho3D::CollisionShape, %arg(PhysicsWorld *), PhysicsWorld, GetPhysicsWorld);
%csattribute(Urho3D::CollisionShape, %arg(ShapeType), ShapeType, GetShapeType);
%csattribute(Urho3D::CollisionShape, %arg(Vector3), Size, GetSize, SetSize);
%csattribute(Urho3D::CollisionShape, %arg(Vector3), Position, GetPosition, SetPosition);
%csattribute(Urho3D::CollisionShape, %arg(Quaternion), Rotation, GetRotation, SetRotation);
%csattribute(Urho3D::CollisionShape, %arg(float), Margin, GetMargin, SetMargin);
%csattribute(Urho3D::CollisionShape, %arg(Model *), Model, GetModel, SetModel);
%csattribute(Urho3D::CollisionShape, %arg(unsigned int), LodLevel, GetLodLevel, SetLodLevel);
%csattribute(Urho3D::CollisionShape, %arg(BoundingBox), WorldBoundingBox, GetWorldBoundingBox);
%csattribute(Urho3D::CollisionShape, %arg(ResourceRef), ModelAttr, GetModelAttr, SetModelAttr);
%csattribute(Urho3D::Constraint, %arg(PhysicsWorld *), PhysicsWorld, GetPhysicsWorld);
%csattribute(Urho3D::Constraint, %arg(ConstraintType), ConstraintType, GetConstraintType);
%csattribute(Urho3D::Constraint, %arg(RigidBody *), OwnBody, GetOwnBody);
%csattribute(Urho3D::Constraint, %arg(RigidBody *), OtherBody, GetOtherBody, SetOtherBody);
%csattribute(Urho3D::Constraint, %arg(Vector3), Position, GetPosition, SetPosition);
%csattribute(Urho3D::Constraint, %arg(Quaternion), Rotation, GetRotation, SetRotation);
%csattribute(Urho3D::Constraint, %arg(Vector3), OtherPosition, GetOtherPosition, SetOtherPosition);
%csattribute(Urho3D::Constraint, %arg(Quaternion), OtherRotation, GetOtherRotation, SetOtherRotation);
%csattribute(Urho3D::Constraint, %arg(Vector3), WorldPosition, GetWorldPosition, SetWorldPosition);
%csattribute(Urho3D::Constraint, %arg(Vector2), HighLimit, GetHighLimit, SetHighLimit);
%csattribute(Urho3D::Constraint, %arg(Vector2), LowLimit, GetLowLimit, SetLowLimit);
...
%csattribute(Urho3D::RigidBody, %arg(PhysicsWorld *), PhysicsWorld, GetPhysicsWorld);
...
%csattribute(Urho3D::RigidBody, %arg(Vector3), Position, GetPosition, SetPosition);
%csattribute(Urho3D::RigidBody, %arg(Quaternion), Rotation, GetRotation, SetRotation);
%csattribute(Urho3D::RigidBody, %arg(Vector3), LinearVelocity, GetLinearVelocity, SetLinearVelocity);
%csattribute(Urho3D::RigidBody, %arg(Vector3), LinearFactor, GetLinearFactor, SetLinearFactor);
...
%csattribute(Urho3D::RigidBody, %arg(Vector3), AngularVelocity, GetAngularVelocity, SetAngularVelocity);
%csattribute(Urho3D::RigidBody, %arg(Vector3), AngularFactor, GetAngularFactor, SetAngularFactor);
...
%csattribute(Urho3D::RigidBody, %arg(Vector3), AnisotropicFriction, GetAnisotropicFriction, SetAnisotropicFriction);
...
%csattribute(Urho3D::RigidBody, %arg(Vector3), GravityOverride, GetGravityOverride, SetGravityOverride);
%csattribute(Urho3D::RigidBody, %arg(Vector3), CenterOfMass, GetCenterOfMass);
...
%csattribute(Urho3D::RigidBody, %arg(CollisionEventMode), CollisionEventMode, GetCollisionEventMode);
%csattribute(Urho3D::KinematicCharacterController, %arg(Vector3), RawPosition, GetRawPosition);
...
%csattribute(Urho3D::KinematicCharacterController, %arg(Vector3), Gravity, GetGravity, SetGravity);
...
%csattribute(Urho3D::KinematicCharacterController, %arg(Vector3), Offset, GetOffset, SetOffset);
...
%csattribute(Urho3D::KinematicCharacterController, %arg(Vector3), AngularVelocity, GetAngularVelocity);
%csattribute(Urho3D::KinematicCharacterController, %arg(Vector3), LinearVelocity, GetLinearVelocity);
%csattribute(Urho3D::RaycastVehicleWheel, %arg(unsigned int), WheelIndex, GetWheelIndex, SetWheelIndex);
%csattribute(Urho3D::RaycastVehicleWheel, %arg(Vector3), ConnectionPoint, GetConnectionPoint);
%csattribute(Urho3D::RaycastVehicleWheel, %arg(Vector3), Offset, GetOffset);
%csattribute(Urho3D::RaycastVehicleWheel, %arg(Quaternion), Rotation, GetRotation);
%csattribute(Urho3D::RaycastVehicleWheel, %arg(Vector3), Direction, GetDirection);
%csattribute(Urho3D::RaycastVehicleWheel, %arg(Vector3), Axle, GetAxle);
...
%csattribute(Urho3D::RaycastVehicleWheel, %arg(Vector3), ContactPosition, GetContactPosition);
%csattribute(Urho3D::RaycastVehicleWheel, %arg(Vector3), ContactNormal, GetContactNormal);
...
%csattribute(Urho3D::RaycastVehicle, %arg(IntVector3), CoordinateSystem, GetCoordinateSystem, SetCoordinateSystem);
%csattribute(Urho3D::TriggerAnimator, %arg(ResourceRef), EnterAnimationAttr, GetEnterAnimationAttr, SetEnterAnimationAttr);
%csattribute(Urho3D::TriggerAnimator, %arg(Animation *), EnterAnimation, GetEnterAnimation, SetEnterAnimation);
%csattribute(Urho3D::TriggerAnimator, %arg(ResourceRef), ExitAnimationAttr, GetExitAnimationAttr, SetExitAnimationAttr);
%csattribute(Urho3D::TriggerAnimator, %arg(Animation *), ExitAnimation, GetExitAnimation, SetExitAnimation);
