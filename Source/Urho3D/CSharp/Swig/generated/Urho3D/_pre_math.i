...
%csattribute(Urho3D::Vector2, %arg(Vector2), OrthogonalClockwise, GetOrthogonalClockwise);
%csattribute(Urho3D::Vector2, %arg(Vector2), OrthogonalCounterClockwise, GetOrthogonalCounterClockwise);
...
%csattribute(Urho3D::IKTrigonometricChain, %arg(IKNode *), BeginNode, GetBeginNode);
%csattribute(Urho3D::IKTrigonometricChain, %arg(IKNode *), MiddleNode, GetMiddleNode);
%csattribute(Urho3D::IKTrigonometricChain, %arg(IKNode *), EndNode, GetEndNode);
...
%csattribute(Urho3D::IKTrigonometricChain, %arg(Quaternion), CurrentChainRotation, GetCurrentChainRotation);
%csattribute(Urho3D::IKEyeChain, %arg(Vector3), LocalEyeOffset, GetLocalEyeOffset);
%csattribute(Urho3D::IKEyeChain, %arg(Vector3), LocalEyeDirection, GetLocalEyeDirection);
...
%csattribute(Urho3D::RandomEngine, %arg(Vector2), DirectionVector2, GetDirectionVector2);
%csattribute(Urho3D::RandomEngine, %arg(Vector3), DirectionVector3, GetDirectionVector3);
%csattribute(Urho3D::RandomEngine, %arg(Quaternion), Quaternion, GetQuaternion);
%csattribute(Urho3D::SphericalHarmonicsDot9, %arg(Color), DebugColor, GetDebugColor);
