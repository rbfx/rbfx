...
// %constant char * DefaultBlockName = Urho3D::defaultBlockName;
// %ignore Urho3D::defaultBlockName;
// %constant char * DefaultElementName = Urho3D::defaultElementName;
...
%csattribute(Urho3D::JSONValue, %arg(ea::string), ValueTypeName, GetValueTypeName);
%csattribute(Urho3D::JSONValue, %arg(ea::string), NumberTypeName, GetNumberTypeName);
%csattribute(Urho3D::JSONValue, %arg(bool), Null, IsNull);
%csattribute(Urho3D::JSONValue, %arg(bool), Bool, IsBool);
%csattribute(Urho3D::JSONValue, %arg(bool), Number, IsNumber);
%csattribute(Urho3D::JSONValue, %arg(bool), String, IsString);
%csattribute(Urho3D::JSONValue, %arg(bool), Array, IsArray);
%csattribute(Urho3D::JSONValue, %arg(bool), Object, IsObject);
...
%csattribute(Urho3D::Image, %arg(bool), Cubemap, IsCubemap);
%csattribute(Urho3D::Image, %arg(bool), Array, IsArray);
%csattribute(Urho3D::Image, %arg(bool), Srgb, IsSRGB);
...
%csattribute(Urho3D::Image, %arg(bool), Compressed, IsCompressed);
...
%csattribute(Urho3D::XMLElement, %arg(bool), Null, IsNull);
...
// %csattribute(Urho3D::JSONOutputArchiveBlock, %arg(Urho3D::ArchiveBlockType), Type, GetType);
%csattribute(Urho3D::JSONInputArchiveBlock, %arg(ea::string_view), Name, GetName);
// %csattribute(Urho3D::JSONInputArchiveBlock, %arg(Urho3D::ArchiveBlockType), Type, GetType);
...
%csattribute(Urho3D::Localization, %arg(int), LanguageIndex, GetLanguageIndex);
%csattribute(Urho3D::Localization, %arg(ea::string), Language, GetLanguage, SetLanguage);
// %csattribute(Urho3D::PListValue, %arg(Urho3D::PListValueType), Type, GetType);
...
// %csattribute(Urho3D::XMLOutputArchiveBlock, %arg(Urho3D::ArchiveBlockType), Type, GetType);
%csattribute(Urho3D::XMLOutputArchiveBlock, %arg(ea::string_view), Name, GetName);
%csattribute(Urho3D::XMLInputArchiveBlock, %arg(ea::string_view), Name, GetName);
// %csattribute(Urho3D::XMLInputArchiveBlock, %arg(Urho3D::ArchiveBlockType), Type, GetType);
