...
%constant BinaryMagic DefaultBinaryMagic = Urho3D::DefaultBinaryMagic;
...
%csattribute(Urho3D::JSONValue, %arg(JSONValueType), ValueType, GetValueType);
%csattribute(Urho3D::JSONValue, %arg(JSONNumberType), NumberType, GetNumberType);
...
%csattribute(Urho3D::Resource, %arg(StringHash), NameHash, GetNameHash);
...
%csattribute(Urho3D::Resource, %arg(AsyncLoadState), AsyncLoadState, GetAsyncLoadState);
%csattribute(Urho3D::Resource, %arg(ea::string), AbsoluteFileName, GetAbsoluteFileName, SetAbsoluteFileName);
%csattribute(Urho3D::ResourceWithMetadata, %arg(StringVector), MetadataKeys, GetMetadataKeys);
...
%csattribute(Urho3D::Image, %arg(TextureFormat), GPUFormat, GetGPUFormat);
...
%csattribute(Urho3D::Image, %arg(IntVector3), Size, GetSize);
...
%csattribute(Urho3D::Image, %arg(CompressedFormat), CompressedFormat, GetCompressedFormat);
%csattribute(Urho3D::Image, %arg(unsigned int), NumCompressedLevels, GetNumCompressedLevels);
%csattribute(Urho3D::Image, %arg(SharedPtr<Image>), NextLevel, GetNextLevel);
%csattribute(Urho3D::Image, %arg(SharedPtr<Image>), NextSibling, GetNextSibling);
%csattribute(Urho3D::Image, %arg(SharedPtr<Image>), DecompressedImage, GetDecompressedImage);
%csattribute(Urho3D::XMLElement, %arg(bool), IsNull, IsNull);
%csattribute(Urho3D::XMLElement, %arg(ea::string), Name, GetName, SetName);
%csattribute(Urho3D::XMLElement, %arg(XMLElement), Parent, GetParent);
...
%csattribute(Urho3D::XMLElement, %arg(BoundingBox), BoundingBox, GetBoundingBox, SetBoundingBox);
%csattribute(Urho3D::XMLElement, %arg(Variant), Variant, GetVariant, SetVariant);
%csattribute(Urho3D::XMLElement, %arg(ResourceRef), ResourceRef, GetResourceRef, SetResourceRef);
%csattribute(Urho3D::XMLElement, %arg(ResourceRefList), ResourceRefList, GetResourceRefList, SetResourceRefList);
%csattribute(Urho3D::XMLElement, %arg(VariantVector), VariantVector, GetVariantVector, SetVariantVector);
%csattribute(Urho3D::XMLElement, %arg(StringVector), StringVector, GetStringVector, SetStringVector);
%csattribute(Urho3D::XMLElement, %arg(VariantMap), VariantMap, GetVariantMap, SetVariantMap);
%csattribute(Urho3D::XMLElement, %arg(StringVariantMap), StringVariantMap, GetStringVariantMap, SetStringVariantMap);
%csattribute(Urho3D::XMLElement, %arg(XMLFile *), File, GetFile);
%csattribute(Urho3D::XMLElement, %arg(pugi::xml_node_struct *), Node, GetNode);
%csattribute(Urho3D::XMLElement, %arg(XPathResultSet *), XPathResultSet, GetXPathResultSet);
...
%csattribute(Urho3D::JSONFile, %arg(JSONValue), Root, GetRoot);
%csattribute(Urho3D::BinaryFile, %arg(ByteVector), Data, GetData, SetData);
%csattribute(Urho3D::BinaryFile, %arg(ea::string_view), Text, GetText);
%csattribute(Urho3D::BinaryFile, %arg(VectorBuffer), MutableBuffer, GetMutableBuffer);
%csattribute(Urho3D::ImageCube, %arg(ea::vector<SharedPtr<Image>>), Images, GetImages);
%csattribute(Urho3D::ImageCube, %arg(XMLFile *), ParametersXML, GetParametersXML);
%csattribute(Urho3D::ImageCube, %arg(unsigned int), SphericalHarmonicsMipLevel, GetSphericalHarmonicsMipLevel);
%csattribute(Urho3D::ImageCube, %arg(SharedPtr<ImageCube>), DecompressedImage, GetDecompressedImage);
...
%csattribute(Urho3D::GraphInPin, %arg(Variant), Value, GetValue, SetValue);
...
%csattribute(Urho3D::GraphNodeProperty, %arg(StringHash), NameHash, GetNameHash);
%csattribute(Urho3D::GraphNode, %arg(unsigned int), Id, GetID);
%csattribute(Urho3D::GraphNode, %arg(Graph *), Graph, GetGraph);
%csattribute(Urho3D::GraphNode, %arg(ea::string), Name, GetName, SetName);
%csattribute(Urho3D::GraphNode, %arg(StringHash), NameHash, GetNameHash);
...
%csattribute(Urho3D::PListValue, %arg(IntRect), IntRect, GetIntRect);
%csattribute(Urho3D::PListValue, %arg(IntVector2), IntVector2, GetIntVector2);
%csattribute(Urho3D::PListValue, %arg(IntVector3), IntVector3, GetIntVector3);
%csattribute(Urho3D::PListValue, %arg(PListValueMap), ValueMap, GetValueMap, SetValueMap);
%csattribute(Urho3D::PListValue, %arg(PListValueVector), ValueVector, GetValueVector, SetValueVector);
%csattribute(Urho3D::PListFile, %arg(PListValueMap), Root, GetRoot);
...
%csattribute(Urho3D::XMLAttributeReference, %arg(XMLElement), Element, GetElement);
