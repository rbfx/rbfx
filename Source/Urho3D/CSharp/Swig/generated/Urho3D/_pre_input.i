%constant IntVector2 MousePositionOffscreen = Urho3D::MOUSE_POSITION_OFFSCREEN;
...
%typemap(csattributes) MouseButton "[global::System.Flags]";
using MouseButtonFlags = MouseButton;
...
%typemap(csattributes) Qualifier "[global::System.Flags]";
using QualifierFlags = Qualifier;
...
%typemap(csattributes) DirectionAggregatorMask "[global::System.Flags]";
using DirectionAggregatorFlags = DirectionAggregatorMask;
...
%typemap(csattributes) DirectionalPadAdapterMask "[global::System.Flags]";
using DirectionalPadAdapterFlags = DirectionalPadAdapterMask;
...
%typemap(csattributes) PointerAdapterMask "[global::System.Flags]";
using PointerAdapterFlags = PointerAdapterMask;
...
%csattribute(Urho3D::Input, %arg(QualifierFlags), Qualifiers, GetQualifiers);
%csattribute(Urho3D::Input, %arg(IntVector2), MousePosition, GetMousePosition, SetMousePosition);
%csattribute(Urho3D::Input, %arg(Vector2), RelativeMousePosition, GetRelativeMousePosition);
%csattribute(Urho3D::Input, %arg(IntVector2), MouseMove, GetMouseMove);
...
%csattribute(Urho3D::Input, %arg(Vector2), SystemToBackbufferScale, GetSystemToBackbufferScale);
...
%csattribute(Urho3D::Input, %arg(MouseMode), MouseMode, GetMouseMode);
%csattribute(Urho3D::Input, %arg(bool), IsMinimized, IsMinimized);
%csattribute(Urho3D::Input, %arg(bool), Enabled, GetEnabled, SetEnabled);
%csattribute(Urho3D::Input, %arg(IntVector2), GlobalWindowPosition, GetGlobalWindowPosition);
%csattribute(Urho3D::Input, %arg(IntVector2), GlobalWindowSize, GetGlobalWindowSize);
%csattribute(Urho3D::Input, %arg(IntVector2), BackbufferSize, GetBackbufferSize);
...
%csattribute(Urho3D::DirectionAggregator, %arg(DirectionAggregatorFlags), SubscriptionMask, GetSubscriptionMask);
%csattribute(Urho3D::DirectionAggregator, %arg(UIElement *), UIElement, GetUIElement, SetUIElement);
%csattribute(Urho3D::DirectionAggregator, %arg(float), DeadZone, GetDeadZone, SetDeadZone);
%csattribute(Urho3D::DirectionAggregator, %arg(Vector2), Direction, GetDirection);
%csattribute(Urho3D::DirectionalPadAdapter, %arg(bool), IsEnabled, IsEnabled, SetEnabled);
%csattribute(Urho3D::DirectionalPadAdapter, %arg(DirectionalPadAdapterFlags), SubscriptionMask, GetSubscriptionMask);
...
%csattribute(Urho3D::Detail::ControllerButtonMapping, %arg(ControllerButton), ControllerButton, GetControllerButton);
%csattribute(Urho3D::Detail::ControllerButtonMapping, %arg(unsigned int), GenericButton, GetGenericButton);
%csattribute(Urho3D::Detail::ControllerAxisMapping, %arg(ControllerAxis), ControllerAxis, GetControllerAxis);
%csattribute(Urho3D::Detail::ControllerAxisMapping, %arg(unsigned int), GenericAxis, GetGenericAxis);
%csattribute(Urho3D::Detail::MouseButtonMapping, %arg(MouseButtonFlags), Mask, GetMask);
%csattribute(Urho3D::InputMap, %arg(float), DeadZone, GetDeadZone, SetDeadZone);
%csattribute(Urho3D::InputMap, %arg(StringActionMappingMap), Mappings, GetMappings);
%csattribute(Urho3D::MoveAndOrbitController, %arg(InputMap *), InputMap, GetInputMap, SetInputMap);
%csattribute(Urho3D::MoveAndOrbitController, %arg(ResourceRef), InputMapAttr, GetInputMapAttr, SetInputMapAttr);
%csattribute(Urho3D::MoveAndOrbitController, %arg(UIElement *), MovementUIElement, GetMovementUIElement, SetMovementUIElement);
%csattribute(Urho3D::MoveAndOrbitController, %arg(UIElement *), RotationUIElement, GetRotationUIElement, SetRotationUIElement);
%csattribute(Urho3D::PointerAdapter, %arg(bool), IsEnabled, IsEnabled, SetEnabled);
%csattribute(Urho3D::PointerAdapter, %arg(PointerAdapterFlags), SubscriptionMask, GetSubscriptionMask);
%csattribute(Urho3D::PointerAdapter, %arg(UIElement *), UIElement, GetUIElement, SetUIElement);
...
%csattribute(Urho3D::PointerAdapter, %arg(IntVector2), PointerPosition, GetPointerPosition);
%csattribute(Urho3D::PointerAdapter, %arg(IntVector2), UIPointerPosition, GetUIPointerPosition);
%csattribute(Urho3D::PointerAdapter, %arg(DirectionAggregator *), DirectionAggregator, GetDirectionAggregator);
