...
%csattribute(Urho3D::FreeFlyController, %arg(float), MouseSensitivity, GetMouseSensitivity, SetMouseSensitivity);
%csattribute(Urho3D::FreeFlyController, %arg(float), TouchSensitivity, GetTouchSensitivity, SetTouchSensitivity);
%csattribute(Urho3D::FreeFlyController, %arg(float), AxisSensitivity, GetAxisSensitivity, SetAxisSensitivity);
