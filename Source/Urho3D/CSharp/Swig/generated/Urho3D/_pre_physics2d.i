...
%csattribute(Urho3D::CollisionShape2D, %arg(Vector2), MassCenter, GetMassCenter);
%csattribute(Urho3D::CollisionShape2D, %arg(b2Fixture *), Fixture, GetFixture);
%csattribute(Urho3D::CollisionBox2D, %arg(Vector2), Size, GetSize, SetSize);
%csattribute(Urho3D::CollisionBox2D, %arg(Vector2), Center, GetCenter, SetCenter);
...
%csattribute(Urho3D::CollisionCircle2D, %arg(Vector2), Center, GetCenter, SetCenter);
%csattribute(Urho3D::CollisionEdge2D, %arg(Vector2), Vertex1, GetVertex1, SetVertex1);
%csattribute(Urho3D::CollisionEdge2D, %arg(Vector2), Vertex2, GetVertex2, SetVertex2);
...
%csattribute(Urho3D::Constraint2D, %arg(RigidBody2D *), OwnerBody, GetOwnerBody);
%csattribute(Urho3D::Constraint2D, %arg(RigidBody2D *), OtherBody, GetOtherBody, SetOtherBody);
%csattribute(Urho3D::Constraint2D, %arg(bool), CollideConnected, GetCollideConnected, SetCollideConnected);
%csattribute(Urho3D::Constraint2D, %arg(Constraint2D *), AttachedConstraint, GetAttachedConstraint, SetAttachedConstraint);
%csattribute(Urho3D::Constraint2D, %arg(b2Joint *), Joint, GetJoint);
%csattribute(Urho3D::ConstraintDistance2D, %arg(Vector2), OwnerBodyAnchor, GetOwnerBodyAnchor, SetOwnerBodyAnchor);
%csattribute(Urho3D::ConstraintDistance2D, %arg(Vector2), OtherBodyAnchor, GetOtherBodyAnchor, SetOtherBodyAnchor);
...
%csattribute(Urho3D::ConstraintFriction2D, %arg(Vector2), Anchor, GetAnchor, SetAnchor);
...
%csattribute(Urho3D::ConstraintGear2D, %arg(Constraint2D *), OwnerConstraint, GetOwnerConstraint, SetOwnerConstraint);
%csattribute(Urho3D::ConstraintGear2D, %arg(Constraint2D *), OtherConstraint, GetOtherConstraint, SetOtherConstraint);
%csattribute(Urho3D::ConstraintGear2D, %arg(float), Ratio, GetRatio, SetRatio);
%csattribute(Urho3D::ConstraintMotor2D, %arg(Vector2), LinearOffset, GetLinearOffset, SetLinearOffset);
...
%csattribute(Urho3D::ConstraintMouse2D, %arg(Vector2), Target, GetTarget, SetTarget);
...
%csattribute(Urho3D::ConstraintPrismatic2D, %arg(Vector2), Anchor, GetAnchor, SetAnchor);
%csattribute(Urho3D::ConstraintPrismatic2D, %arg(Vector2), Axis, GetAxis, SetAxis);
...
%csattribute(Urho3D::ConstraintPulley2D, %arg(Vector2), OwnerBodyGroundAnchor, GetOwnerBodyGroundAnchor, SetOwnerBodyGroundAnchor);
%csattribute(Urho3D::ConstraintPulley2D, %arg(Vector2), OtherBodyGroundAnchor, GetOtherBodyGroundAnchor, SetOtherBodyGroundAnchor);
%csattribute(Urho3D::ConstraintPulley2D, %arg(Vector2), OwnerBodyAnchor, GetOwnerBodyAnchor, SetOwnerBodyAnchor);
%csattribute(Urho3D::ConstraintPulley2D, %arg(Vector2), OtherBodyAnchor, GetOtherBodyAnchor, SetOtherBodyAnchor);
%csattribute(Urho3D::ConstraintPulley2D, %arg(float), Ratio, GetRatio, SetRatio);
%csattribute(Urho3D::ConstraintRevolute2D, %arg(Vector2), Anchor, GetAnchor, SetAnchor);
...
%csattribute(Urho3D::ConstraintRope2D, %arg(Vector2), OwnerBodyAnchor, GetOwnerBodyAnchor, SetOwnerBodyAnchor);
%csattribute(Urho3D::ConstraintRope2D, %arg(Vector2), OtherBodyAnchor, GetOtherBodyAnchor, SetOtherBodyAnchor);
%csattribute(Urho3D::ConstraintRope2D, %arg(float), MaxLength, GetMaxLength, SetMaxLength);
%csattribute(Urho3D::ConstraintWeld2D, %arg(Vector2), Anchor, GetAnchor, SetAnchor);
...
%csattribute(Urho3D::ConstraintWheel2D, %arg(Vector2), Anchor, GetAnchor, SetAnchor);
%csattribute(Urho3D::ConstraintWheel2D, %arg(Vector2), Axis, GetAxis, SetAxis);
...
%csattribute(Urho3D::PhysicsWorld2D, %arg(Vector2), Gravity, GetGravity, SetGravity);
...
%csattribute(Urho3D::RigidBody2D, %arg(BodyType2D), BodyType, GetBodyType);
...
%csattribute(Urho3D::RigidBody2D, %arg(Vector2), MassCenter, GetMassCenter, SetMassCenter);
...
%csattribute(Urho3D::RigidBody2D, %arg(Vector2), LinearVelocity, GetLinearVelocity, SetLinearVelocity);
