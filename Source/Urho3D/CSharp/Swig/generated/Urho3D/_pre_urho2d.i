...
%csattribute(Urho3D::CollisionShape2D, %arg(bool), Trigger, IsTrigger, SetTrigger);
...
%csattribute(Urho3D::ParticleEmitter2D, %arg(bool), Emitting, IsEmitting, SetEmitting);
%csattribute(Urho3D::PhysicsWorld2D, %arg(bool), UpdateEnabled, IsUpdateEnabled, SetUpdateEnabled);
...
%csattribute(Urho3D::PhysicsWorld2D, %arg(bool), ApplyingTransforms, IsApplyingTransforms, SetApplyingTransforms);
...
%csattribute(Urho3D::RigidBody2D, %arg(bool), AllowSleep, IsAllowSleep, SetAllowSleep);
%csattribute(Urho3D::RigidBody2D, %arg(bool), FixedRotation, IsFixedRotation, SetFixedRotation);
%csattribute(Urho3D::RigidBody2D, %arg(bool), Bullet, IsBullet, SetBullet);
%csattribute(Urho3D::RigidBody2D, %arg(float), GravityScale, GetGravityScale, SetGravityScale);
%csattribute(Urho3D::RigidBody2D, %arg(bool), Awake, IsAwake, SetAwake);
...
// %csattribute(Urho3D::TileMapObject2D, %arg(ea::string), Type, GetType);
...
%csattribute(Urho3D::TileMapLayer2D, %arg(bool), Visible, IsVisible, SetVisible);
...
// %csattribute(Urho3D::TmxLayer2D, %arg(Urho3D::TileMapLayerType2D), Type, GetType);
...
%csattribute(Urho3D::TmxLayer2D, %arg(bool), Visible, IsVisible);
