...
%csattribute(Urho3D::StaticSprite2D, %arg(Sprite2D *), Sprite, GetSprite, SetSprite);
%csattribute(Urho3D::StaticSprite2D, %arg(Rect), DrawRect, GetDrawRect, SetDrawRect);
%csattribute(Urho3D::StaticSprite2D, %arg(Rect), TextureRect, GetTextureRect, SetTextureRect);
%csattribute(Urho3D::StaticSprite2D, %arg(BlendMode), BlendMode, GetBlendMode);
...
%csattribute(Urho3D::StaticSprite2D, %arg(Color), Color, GetColor, SetColor);
...
%csattribute(Urho3D::StaticSprite2D, %arg(Vector2), HotSpot, GetHotSpot, SetHotSpot);
%csattribute(Urho3D::StaticSprite2D, %arg(Material *), CustomMaterial, GetCustomMaterial, SetCustomMaterial);
%csattribute(Urho3D::StaticSprite2D, %arg(ResourceRef), SpriteAttr, GetSpriteAttr, SetSpriteAttr);
%csattribute(Urho3D::StaticSprite2D, %arg(ResourceRef), CustomMaterialAttr, GetCustomMaterialAttr, SetCustomMaterialAttr);
%csattribute(Urho3D::AnimatedSprite2D, %arg(AnimationSet2D *), AnimationSet, GetAnimationSet, SetAnimationSet);
%csattribute(Urho3D::AnimatedSprite2D, %arg(ea::string), Entity, GetEntity, SetEntity);
%csattribute(Urho3D::AnimatedSprite2D, %arg(LoopMode2D), LoopMode, GetLoopMode);
%csattribute(Urho3D::AnimatedSprite2D, %arg(float), Speed, GetSpeed, SetSpeed);
%csattribute(Urho3D::AnimatedSprite2D, %arg(ResourceRef), AnimationSetAttr, GetAnimationSetAttr, SetAnimationSetAttr);
%csattribute(Urho3D::AnimationSet2D, %arg(unsigned int), NumAnimations, GetNumAnimations);
%csattribute(Urho3D::AnimationSet2D, %arg(Sprite2D *), Sprite, GetSprite);
%csattribute(Urho3D::AnimationSet2D, %arg(Spriter::SpriterData *), SpriterData, GetSpriterData);
%csattribute(Urho3D::ParticleEffect2D, %arg(Sprite2D *), Sprite, GetSprite, SetSprite);
%csattribute(Urho3D::ParticleEffect2D, %arg(Vector2), SourcePositionVariance, GetSourcePositionVariance, SetSourcePositionVariance);
...
%csattribute(Urho3D::ParticleEffect2D, %arg(Vector2), Gravity, GetGravity, SetGravity);
...
%csattribute(Urho3D::ParticleEffect2D, %arg(Color), StartColor, GetStartColor, SetStartColor);
%csattribute(Urho3D::ParticleEffect2D, %arg(Color), StartColorVariance, GetStartColorVariance, SetStartColorVariance);
%csattribute(Urho3D::ParticleEffect2D, %arg(Color), FinishColor, GetFinishColor, SetFinishColor);
%csattribute(Urho3D::ParticleEffect2D, %arg(Color), FinishColorVariance, GetFinishColorVariance, SetFinishColorVariance);
...
%csattribute(Urho3D::ParticleEffect2D, %arg(EmitterType2D), EmitterType, GetEmitterType);
...
%csattribute(Urho3D::ParticleEffect2D, %arg(BlendMode), BlendMode, GetBlendMode);
...
%csattribute(Urho3D::ParticleEmitter2D, %arg(ParticleEffect2D *), Effect, GetEffect, SetEffect);
%csattribute(Urho3D::ParticleEmitter2D, %arg(Sprite2D *), Sprite, GetSprite, SetSprite);
%csattribute(Urho3D::ParticleEmitter2D, %arg(BlendMode), BlendMode, GetBlendMode);
%csattribute(Urho3D::ParticleEmitter2D, %arg(unsigned int), MaxParticles, GetMaxParticles, SetMaxParticles);
%csattribute(Urho3D::ParticleEmitter2D, %arg(ResourceRef), ParticleEffectAttr, GetParticleEffectAttr, SetParticleEffectAttr);
%csattribute(Urho3D::ParticleEmitter2D, %arg(ResourceRef), SpriteAttr, GetSpriteAttr, SetSpriteAttr);
%csattribute(Urho3D::ParticleEmitter2D, %arg(bool), IsEmitting, IsEmitting, SetEmitting);
%csattribute(Urho3D::Sprite2D, %arg(Texture2D *), Texture, GetTexture, SetTexture);
%csattribute(Urho3D::Sprite2D, %arg(IntRect), Rectangle, GetRectangle, SetRectangle);
%csattribute(Urho3D::Sprite2D, %arg(Vector2), HotSpot, GetHotSpot, SetHotSpot);
%csattribute(Urho3D::Sprite2D, %arg(IntVector2), Offset, GetOffset, SetOffset);
%csattribute(Urho3D::Sprite2D, %arg(float), TextureEdgeOffset, GetTextureEdgeOffset, SetTextureEdgeOffset);
%csattribute(Urho3D::Sprite2D, %arg(SpriteSheet2D *), SpriteSheet, GetSpriteSheet, SetSpriteSheet);
%csattribute(Urho3D::SpriteSheet2D, %arg(Texture2D *), Texture, GetTexture, SetTexture);
%csattribute(Urho3D::SpriteSheet2D, %arg(ea::unordered_map<ea::string, SharedPtr<Sprite2D>>), SpriteMapping, GetSpriteMapping);
%csattribute(Urho3D::Spriter::BoneTimelineKey, %arg(ObjectType), ObjectType, GetObjectType);
%csattribute(Urho3D::Spriter::SpriteTimelineKey, %arg(ObjectType), ObjectType, GetObjectType);
...
%csattribute(Urho3D::StretchableSprite2D, %arg(IntRect), Border, GetBorder, SetBorder);
...
%csattribute(Urho3D::Tile2D, %arg(Sprite2D *), Sprite, GetSprite);
%csattribute(Urho3D::TileMapObject2D, %arg(TileMapObjectType2D), ObjectType, GetObjectType);
%csattribute(Urho3D::TileMapObject2D, %arg(ea::string), Name, GetName);
%csattribute(Urho3D::TileMapObject2D, %arg(Vector2), Position, GetPosition);
%csattribute(Urho3D::TileMapObject2D, %arg(Vector2), Size, GetSize);
...
%csattribute(Urho3D::TileMapObject2D, %arg(Sprite2D *), TileSprite, GetTileSprite);
%csattribute(Urho3D::TileMap2D, %arg(TmxFile2D *), TmxFile, GetTmxFile, SetTmxFile);
%csattribute(Urho3D::TileMap2D, %arg(TileMapInfo2D), Info, GetInfo);
%csattribute(Urho3D::TileMap2D, %arg(unsigned int), NumLayers, GetNumLayers);
%csattribute(Urho3D::TileMap2D, %arg(ResourceRef), TmxFileAttr, GetTmxFileAttr, SetTmxFileAttr);
%csattribute(Urho3D::TileMapLayer2D, %arg(TileMap2D *), TileMap, GetTileMap);
%csattribute(Urho3D::TileMapLayer2D, %arg(TmxLayer2D *), TmxLayer, GetTmxLayer);
...
%csattribute(Urho3D::TileMapLayer2D, %arg(TileMapLayerType2D), LayerType, GetLayerType);
...
%csattribute(Urho3D::TileMapLayer2D, %arg(Node *), ImageNode, GetImageNode);
%csattribute(Urho3D::TmxLayer2D, %arg(TmxFile2D *), TmxFile, GetTmxFile);
...
%csattribute(Urho3D::TmxImageLayer2D, %arg(Vector2), Position, GetPosition);
%csattribute(Urho3D::TmxImageLayer2D, %arg(ea::string), Source, GetSource);
%csattribute(Urho3D::TmxImageLayer2D, %arg(Sprite2D *), Sprite, GetSprite);
%csattribute(Urho3D::TmxFile2D, %arg(TileMapInfo2D), Info, GetInfo);
