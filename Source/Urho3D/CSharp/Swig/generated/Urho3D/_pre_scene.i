...
%typemap(csattributes) PrefabArchiveFlag "[global::System.Flags]";
using PrefabArchiveFlags = PrefabArchiveFlag;
...
%typemap(csattributes) PrefabSaveFlag "[global::System.Flags]";
using PrefabSaveFlags = PrefabSaveFlag;
...
%typemap(csattributes) PrefabLoadFlag "[global::System.Flags]";
using PrefabLoadFlags = PrefabLoadFlag;
%typemap(ctype) PrefabLoadFlags "size_t";
%typemap(out) PrefabLoadFlags "$result = (size_t)$1.AsInteger();"
%csconstvalue("0") Urho3D::None;
%typemap(csattributes) SceneLookupFlag "[global::System.Flags]";
using SceneLookupFlags = SceneLookupFlag;
...
%typemap(csattributes) UpdateEvent "[global::System.Flags]";
using UpdateEventFlags = UpdateEvent;
...
%typemap(csattributes) PrefabInlineFlag "[global::System.Flags]";
using PrefabInlineFlags = PrefabInlineFlag;
...
%typemap(csattributes) PrefabInstanceFlag "[global::System.Flags]";
using PrefabInstanceFlags = PrefabInstanceFlag;
...
%csattribute(Urho3D::Component, %arg(AttributeScopeHint), EffectiveScopeHint, GetEffectiveScopeHint);
%csattribute(Urho3D::Component, %arg(unsigned int), Id, GetID);
%csattribute(Urho3D::Component, %arg(Node *), Node, GetNode);
%csattribute(Urho3D::Component, %arg(Scene *), Scene, GetScene);
...
%csattribute(Urho3D::ValueAnimationInfo, %arg(Object *), Target, GetTarget);
%csattribute(Urho3D::ValueAnimationInfo, %arg(ValueAnimation *), Animation, GetAnimation);
%csattribute(Urho3D::ValueAnimationInfo, %arg(WrapMode), WrapMode, GetWrapMode);
...
%csattribute(Urho3D::AttributeAnimationInfo, %arg(AttributeInfo), AttributeInfo, GetAttributeInfo);
%csattribute(Urho3D::Animatable, %arg(bool), AnimationEnabled, GetAnimationEnabled, SetAnimationEnabled);
%csattribute(Urho3D::Animatable, %arg(ObjectAnimation *), ObjectAnimation, GetObjectAnimation, SetObjectAnimation);
%csattribute(Urho3D::Animatable, %arg(ResourceRef), ObjectAnimationAttr, GetObjectAnimationAttr, SetObjectAnimationAttr);
%csattribute(Urho3D::Node, %arg(AttributeScopeHint), EffectiveScopeHint, GetEffectiveScopeHint);
%csattribute(Urho3D::Node, %arg(unsigned int), Id, GetID, SetID);
%csattribute(Urho3D::Node, %arg(ea::string), Name, GetName, SetName);
%csattribute(Urho3D::Node, %arg(StringHash), NameHash, GetNameHash);
%csattribute(Urho3D::Node, %arg(ea::string), FullNameDebug, GetFullNameDebug);
%csattribute(Urho3D::Node, %arg(StringVector), Tags, GetTags, SetTags);
%csattribute(Urho3D::Node, %arg(Node *), Parent, GetParent, SetParent);
%csattribute(Urho3D::Node, %arg(Scene *), Scene, GetScene, SetScene);
...
%csattribute(Urho3D::Node, %arg(Vector3), Position, GetPosition, SetPosition);
%csattribute(Urho3D::Node, %arg(Vector2), Position2D, GetPosition2D, SetPosition2D);
%csattribute(Urho3D::Node, %arg(Quaternion), Rotation, GetRotation, SetRotation);
%csattribute(Urho3D::Node, %arg(float), Rotation2D, GetRotation2D, SetRotation2D);
%csattribute(Urho3D::Node, %arg(Vector3), Direction, GetDirection, SetDirection);
%csattribute(Urho3D::Node, %arg(Vector3), Up, GetUp);
%csattribute(Urho3D::Node, %arg(Vector3), Right, GetRight);
%csattribute(Urho3D::Node, %arg(Matrix3x4), TransformMatrix, GetTransformMatrix, SetTransformMatrix);
%csattribute(Urho3D::Node, %arg(Transform), Transform, GetTransform, SetTransform);
%csattribute(Urho3D::Node, %arg(Vector3), WorldPosition, GetWorldPosition, SetWorldPosition);
%csattribute(Urho3D::Node, %arg(Vector2), WorldPosition2D, GetWorldPosition2D, SetWorldPosition2D);
%csattribute(Urho3D::Node, %arg(Quaternion), WorldRotation, GetWorldRotation, SetWorldRotation);
%csattribute(Urho3D::Node, %arg(float), WorldRotation2D, GetWorldRotation2D, SetWorldRotation2D);
%csattribute(Urho3D::Node, %arg(Vector3), WorldDirection, GetWorldDirection, SetWorldDirection);
%csattribute(Urho3D::Node, %arg(Vector3), WorldUp, GetWorldUp);
%csattribute(Urho3D::Node, %arg(Vector3), WorldRight, GetWorldRight);
%csattribute(Urho3D::Node, %arg(Vector3), WorldScale, GetWorldScale, SetWorldScale);
%csattribute(Urho3D::Node, %arg(Vector3), SignedWorldScale, GetSignedWorldScale);
%csattribute(Urho3D::Node, %arg(Vector2), WorldScale2D, GetWorldScale2D, SetWorldScale2D);
%csattribute(Urho3D::Node, %arg(Matrix3x4), WorldTransform, GetWorldTransform, SetWorldTransform);
...
%csattribute(Urho3D::Node, %arg(StringVariantMap), Vars, GetVars);
...
%csattribute(Urho3D::Scene, %arg(LoadMode), AsyncLoadMode, GetAsyncLoadMode);
...
%csattribute(Urho3D::Scene, %arg(ea::unordered_map<unsigned int, Node *>), AllNodes, GetAllNodes);
%csattribute(Urho3D::Scene, %arg(ea::unordered_map<unsigned int, Component *>), AllComponents, GetAllComponents);
...
%csattribute(Urho3D::ReferencedComponentBase, %arg(ComponentReference), Reference, GetReference);
%csattribute(Urho3D::ReferencedComponentRegistryBase, %arg(unsigned int), ReferenceIndexUpperBound, GetReferenceIndexUpperBound);
%csattribute(Urho3D::LogicComponent, %arg(UpdateEventFlags), UpdateEventMask, GetUpdateEventMask);
%csattribute(Urho3D::LogicComponent, %arg(bool), IsDelayedStartCalled, IsDelayedStartCalled);
%csattribute(Urho3D::AttributePrefab, %arg(AttributeId), Id, GetId);
%csattribute(Urho3D::AttributePrefab, %arg(ea::string), Name, GetName);
%csattribute(Urho3D::AttributePrefab, %arg(StringHash), NameHash, GetNameHash);
%csattribute(Urho3D::AttributePrefab, %arg(Variant), Value, GetValue, SetValue);
%csattribute(Urho3D::SerializablePrefab, %arg(ea::string), TypeName, GetTypeName);
%csattribute(Urho3D::SerializablePrefab, %arg(StringHash), TypeNameHash, GetTypeNameHash);
%csattribute(Urho3D::SerializablePrefab, %arg(SerializableId), Id, GetId);
...
%csattribute(Urho3D::NodePrefab, %arg(SerializablePrefab), Node, GetNode);
%csattribute(Urho3D::NodePrefab, %arg(SerializablePrefab), MutableNode, GetMutableNode);
...
%csattribute(Urho3D::PrefabResource, %arg(NodePrefab), ScenePrefab, GetScenePrefab);
%csattribute(Urho3D::PrefabResource, %arg(NodePrefab), MutableScenePrefab, GetMutableScenePrefab);
%csattribute(Urho3D::PrefabResource, %arg(NodePrefab), NodePrefab, GetNodePrefab);
%csattribute(Urho3D::PrefabResource, %arg(NodePrefab), MutableNodePrefab, GetMutableNodePrefab);
%csattribute(Urho3D::PrefabReference, %arg(ea::string), Path, GetPath);
%csattribute(Urho3D::PrefabReference, %arg(ResourceRef), PrefabAttr, GetPrefabAttr, SetPrefabAttr);
%csattribute(Urho3D::PrefabWriterToMemory, %arg(bool), IsEOF, IsEOF);
%csattribute(Urho3D::PrefabWriterToMemory, %arg(PrefabSaveFlags), Flags, GetFlags);
%csattribute(Urho3D::PrefabWriterToArchive, %arg(bool), IsEOF, IsEOF);
%csattribute(Urho3D::PrefabWriterToArchive, %arg(PrefabSaveFlags), Flags, GetFlags);
%csattribute(Urho3D::SceneResource, %arg(Scene *), Scene, GetScene);
...
%csattribute(Urho3D::ShakeComponent, %arg(Vector3), ShiftRange, GetShiftRange, SetShiftRange);
%csattribute(Urho3D::ShakeComponent, %arg(Vector3), RotationRange, GetRotationRange, SetRotationRange);
%csattribute(Urho3D::SplinePath, %arg(InterpolationMode), InterpolationMode, GetInterpolationMode);
%csattribute(Urho3D::SplinePath, %arg(float), Speed, GetSpeed, SetSpeed);
%csattribute(Urho3D::SplinePath, %arg(float), Length, GetLength);
%csattribute(Urho3D::SplinePath, %arg(Vector3), Position, GetPosition);
%csattribute(Urho3D::SplinePath, %arg(Node *), ControlledNode, GetControlledNode, SetControlledNode);
%csattribute(Urho3D::SplinePath, %arg(bool), IsFinished, IsFinished);
%csattribute(Urho3D::SplinePath, %arg(VariantVector), ControlPointIdsAttr, GetControlPointIdsAttr, SetControlPointIdsAttr);
...
%csattribute(Urho3D::ValueAnimation, %arg(InterpMethod), InterpolationMethod, GetInterpolationMethod);
%csattribute(Urho3D::ValueAnimation, %arg(float), SplineTension, GetSplineTension, SetSplineTension);
%csattribute(Urho3D::ValueAnimation, %arg(VariantType), ValueType, GetValueType);
