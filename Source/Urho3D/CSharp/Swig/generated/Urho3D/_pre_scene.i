...
%csattribute(Urho3D::Serializable, %arg(bool), Temporary, IsTemporary, SetTemporary);
...
%csattribute(Urho3D::Component, %arg(bool), Replicated, IsReplicated);
%csattribute(Urho3D::Component, %arg(Urho3D::Node *), Node, GetNode);
%csattribute(Urho3D::Component, %arg(Urho3D::Scene *), Scene, GetScene);
%csattribute(Urho3D::Component, %arg(bool), Enabled, IsEnabled, SetEnabled);
%csattribute(Urho3D::Component, %arg(bool), EnabledEffective, IsEnabledEffective);
...
%csattribute(Urho3D::LogicComponent, %arg(bool), DelayedStartCalled, IsDelayedStartCalled);
%csattribute(Urho3D::Node, %arg(unsigned int), Id, GetID, SetID);
%csattribute(Urho3D::Node, %arg(bool), Replicated, IsReplicated);
...
%csattribute(Urho3D::Node, %arg(bool), Enabled, IsEnabled, SetEnabled);
%csattribute(Urho3D::Node, %arg(bool), EnabledSelf, IsEnabledSelf);
...
%csattribute(Urho3D::Node, %arg(bool), Dirty, IsDirty);
%csattribute(Urho3D::Node, %arg(ea::vector<SharedPtr<Node>>), Children, GetChildren);
...
%csattribute(Urho3D::Node, %arg(ea::vector<SharedPtr<Component>>), Components, GetComponents);
...
%csattribute(Urho3D::Scene, %arg(bool), UpdateEnabled, IsUpdateEnabled, SetUpdateEnabled);
%csattribute(Urho3D::Scene, %arg(bool), AsyncLoading, IsAsyncLoading);
...
%csattribute(Urho3D::Scene, %arg(bool), ThreadedUpdate, IsThreadedUpdate);
...
%csattribute(Urho3D::SmoothedTransform, %arg(bool), InProgress, IsInProgress);
...
%csattribute(Urho3D::SplinePath, %arg(bool), Finished, IsFinished);
...
%csattribute(Urho3D::UnknownComponent, %arg(Urho3D::StringHash), Type, GetType, SetType);
...
%csattribute(Urho3D::ValueAnimation, %arg(bool), Valid, IsValid);
