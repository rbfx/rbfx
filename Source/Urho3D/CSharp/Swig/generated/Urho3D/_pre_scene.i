...
%csattribute(Urho3D::PrefabReference, %arg(bool), PreserveTransfrom, GetPreserveTransfrom, SetPreserveTransfrom);
%csattribute(Urho3D::PrefabReference, %arg(Urho3D::ResourceRef), PrefabAttr, GetPrefabAttr, SetPrefabAttr);
%csattribute(Urho3D::PrefabReference, %arg(Urho3D::Node *), RootNode, GetRootNode);
