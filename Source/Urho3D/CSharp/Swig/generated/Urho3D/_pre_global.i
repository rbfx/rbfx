...
%csattribute(ImGuiTextFilter, %arg(bool), Active, IsActive);
%csattribute(ImDrawList, %arg(ImVec2), ClipRectMin, GetClipRectMin);
%csattribute(ImDrawList, %arg(ImVec2), ClipRectMax, GetClipRectMax);
%csattribute(ImFontAtlasCustomRect, %arg(bool), Packed, IsPacked);
%csattribute(ImFontAtlas, %arg(bool), Built, IsBuilt);
...
%csattribute(ImFont, %arg(bool), Loaded, IsLoaded);
...
%csattribute(ImRect, %arg(bool), Inverted, IsInverted);
...
%csattribute(ImGuiDockNode, %arg(bool), RootNode, IsRootNode);
%csattribute(ImGuiDockNode, %arg(bool), DockSpace, IsDockSpace);
%csattribute(ImGuiDockNode, %arg(bool), FloatingNode, IsFloatingNode);
%csattribute(ImGuiDockNode, %arg(bool), HiddenTabBar, IsHiddenTabBar);
%csattribute(ImGuiDockNode, %arg(bool), NoTabBar, IsNoTabBar);
%csattribute(ImGuiDockNode, %arg(bool), SplitNode, IsSplitNode);
%csattribute(ImGuiDockNode, %arg(bool), LeafNode, IsLeafNode);
%csattribute(ImGuiDockNode, %arg(bool), Empty, IsEmpty);
