...
%csconstvalue("1") ImGuiTableColumnFlags_DefaultHide;
%csconstvalue("2") ImGuiTableColumnFlags_DefaultSort;
%csconstvalue("4") ImGuiTableColumnFlags_WidthStretch;
%csconstvalue("8") ImGuiTableColumnFlags_WidthFixed;
%csconstvalue("16") ImGuiTableColumnFlags_NoResize;
%csconstvalue("32") ImGuiTableColumnFlags_NoReorder;
%csconstvalue("64") ImGuiTableColumnFlags_NoHide;
%csconstvalue("128") ImGuiTableColumnFlags_NoClip;
%csconstvalue("256") ImGuiTableColumnFlags_NoSort;
%csconstvalue("512") ImGuiTableColumnFlags_NoSortAscending;
%csconstvalue("1024") ImGuiTableColumnFlags_NoSortDescending;
%csconstvalue("2048") ImGuiTableColumnFlags_NoHeaderWidth;
%csconstvalue("4096") ImGuiTableColumnFlags_PreferSortAscending;
%csconstvalue("8192") ImGuiTableColumnFlags_PreferSortDescending;
%csconstvalue("16384") ImGuiTableColumnFlags_IndentEnable;
%csconstvalue("32768") ImGuiTableColumnFlags_IndentDisable;
%csconstvalue("1048576") ImGuiTableColumnFlags_IsEnabled;
%csconstvalue("2097152") ImGuiTableColumnFlags_IsVisible;
%csconstvalue("4194304") ImGuiTableColumnFlags_IsSorted;
%csconstvalue("8388608") ImGuiTableColumnFlags_IsHovered;
%csconstvalue("12") ImGuiTableColumnFlags_WidthMask_;
%csconstvalue("49152") ImGuiTableColumnFlags_IndentMask_;
%csconstvalue("15728640") ImGuiTableColumnFlags_StatusMask_;
...
%rename(ImGuiItemAddFlags) ImGuiItemAddFlags_;
%typemap(csattributes) ImGuiItemAddFlags_ "[global::System.Flags]";
%csconstvalue("0") ImGuiItemAddFlags_None;
%csconstvalue("1") ImGuiItemAddFlags_Focusable;
...
%csconstvalue("256") ImGuiItemStatusFlags_FocusedByCode;
%csconstvalue("512") ImGuiItemStatusFlags_FocusedByTabbing;
%csconstvalue("768") ImGuiItemStatusFlags_Focused;
