...
%csattribute(Urho3D::DynamicModule, %arg(ModuleType), ModuleType, GetModuleType);
...
%csattribute(Urho3D::Plugin, %arg(PluginApplication *), Application, GetApplication);
...
%csattribute(Urho3D::PluginStack, %arg(PluginApplication *), MainPlugin, GetMainPlugin);
%csattribute(Urho3D::PluginManager, %arg(bool), IsStarted, IsStarted);
%csattribute(Urho3D::PluginManager, %arg(StringVector), LoadedPlugins, GetLoadedPlugins);
...
%csattribute(Urho3D::PluginManager, %arg(PluginApplication *), MainPlugin, GetMainPlugin);
