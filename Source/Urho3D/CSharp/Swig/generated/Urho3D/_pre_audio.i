...
%csattribute(Urho3D::Audio, %arg(bool), Stereo, IsStereo);
%csattribute(Urho3D::Audio, %arg(bool), Playing, IsPlaying);
%csattribute(Urho3D::Audio, %arg(bool), Initialized, IsInitialized);
...
%csattribute(Urho3D::SoundStream, %arg(bool), SixteenBit, IsSixteenBit);
%csattribute(Urho3D::SoundStream, %arg(bool), Stereo, IsStereo);
...
%csattribute(Urho3D::Sound, %arg(bool), Looped, IsLooped, SetLooped);
%csattribute(Urho3D::Sound, %arg(bool), SixteenBit, IsSixteenBit);
%csattribute(Urho3D::Sound, %arg(bool), Stereo, IsStereo);
%csattribute(Urho3D::Sound, %arg(bool), Compressed, IsCompressed);
...
%csattribute(Urho3D::SoundSource, %arg(bool), Playing, IsPlaying);
