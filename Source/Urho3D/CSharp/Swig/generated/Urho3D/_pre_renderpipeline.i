...
%typemap(csattributes) DrawableProcessorPassFlag "[global::System.Flags]";
using DrawableProcessorPassFlags = DrawableProcessorPassFlag;
...
%typemap(csattributes) BatchRenderFlag "[global::System.Flags]";
using BatchRenderFlags = BatchRenderFlag;
%typemap(ctype) BatchRenderFlags "size_t";
%typemap(out) BatchRenderFlags "$result = (size_t)$1.AsInteger();"
%typemap(csattributes) RenderBufferFlag "[global::System.Flags]";
using RenderBufferFlags = RenderBufferFlag;
...
%typemap(csattributes) PostProcessPassFlag "[global::System.Flags]";
using PostProcessPassFlags = PostProcessPassFlag;
...
%csattribute(Urho3D::RenderPipelineDebugger, %arg(DebugFrameSnapshot), Snapshot, GetSnapshot);
%csattribute(Urho3D::RenderPipelineView, %arg(RenderPipeline *), RenderPipeline, GetRenderPipeline);
%csattribute(Urho3D::RenderPipeline, %arg(RenderPipelineSettings), Settings, GetSettings, SetSettings);
%csattribute(Urho3D::SimplePostProcessPass, %arg(PostProcessPassFlags), ExecutionFlags, GetExecutionFlags);
%csattribute(Urho3D::TextureRenderBuffer, %arg(RawTexture *), Texture, GetTexture);
%csattribute(Urho3D::TextureRenderBuffer, %arg(IntRect), ViewportRect, GetViewportRect);
%csattribute(Urho3D::ViewportColorRenderBuffer, %arg(RawTexture *), Texture, GetTexture);
%csattribute(Urho3D::ViewportColorRenderBuffer, %arg(IntRect), ViewportRect, GetViewportRect);
%csattribute(Urho3D::ViewportDepthStencilRenderBuffer, %arg(RawTexture *), Texture, GetTexture);
%csattribute(Urho3D::ViewportDepthStencilRenderBuffer, %arg(IntRect), ViewportRect, GetViewportRect);
%csattribute(Urho3D::AmbientOcclusionPass, %arg(PostProcessPassFlags), ExecutionFlags, GetExecutionFlags);
%csattribute(Urho3D::AutoExposurePass, %arg(PostProcessPassFlags), ExecutionFlags, GetExecutionFlags);
%csattribute(Urho3D::LightAccumulator, %arg(VertexLightContainer), VertexLights, GetVertexLights);
...
%csattribute(Urho3D::DrawableProcessorPass, %arg(DrawableProcessorPassFlags), Flags, GetFlags);
%csattribute(Urho3D::DrawableProcessor, %arg(FrameInfo), FrameInfo, GetFrameInfo);
%csattribute(Urho3D::DrawableProcessor, %arg(DrawableProcessorSettings), Settings, GetSettings, SetSettings);
%csattribute(Urho3D::DrawableProcessor, %arg(ea::vector<SortedOccluder>), Occluders, GetOccluders);
%csattribute(Urho3D::DrawableProcessor, %arg(WorkQueueVector<Drawable *>), Geometries, GetGeometries);
%csattribute(Urho3D::DrawableProcessor, %arg(FloatRange), SceneZRange, GetSceneZRange);
...
%csattribute(Urho3D::InstancingBuffer, %arg(InstancingBufferSettings), Settings, GetSettings, SetSettings);
%csattribute(Urho3D::InstancingBuffer, %arg(VertexBuffer *), VertexBuffer, GetVertexBuffer);
%csattribute(Urho3D::InstancingBuffer, %arg(bool), IsEnabled, IsEnabled);
%csattribute(Urho3D::PipelineBatch, %arg(SourceBatch), SourceBatch, GetSourceBatch);
%csattribute(Urho3D::PipelineBatchDesc, %arg(BatchStateCreateKey), Key, GetKey);
%csattribute(Urho3D::BatchCompositor, %arg(ea::vector<PipelineBatchByState>), LightVolumeBatches, GetLightVolumeBatches);
%csattribute(Urho3D::BloomPass, %arg(PostProcessPassFlags), ExecutionFlags, GetExecutionFlags);
...
%csattribute(Urho3D::CameraProcessor, %arg(FillMode), CameraFillMode, GetCameraFillMode);
%csattribute(Urho3D::PipelineStateBuilder, %arg(ShaderProgramCompositor *), ShaderProgramCompositor, GetShaderProgramCompositor);
%csattribute(Urho3D::UnorderedScenePass, %arg(PipelineBatchGroup<PipelineBatchByState>), DeferredBatches, GetDeferredBatches);
%csattribute(Urho3D::UnorderedScenePass, %arg(PipelineBatchGroup<PipelineBatchByState>), BaseBatches, GetBaseBatches);
%csattribute(Urho3D::UnorderedScenePass, %arg(PipelineBatchGroup<PipelineBatchByState>), LightBatches, GetLightBatches);
%csattribute(Urho3D::BackToFrontScenePass, %arg(PipelineBatchGroup<PipelineBatchBackToFront>), Batches, GetBatches);
%csattribute(Urho3D::OutlineScenePass, %arg(PipelineBatchGroup<PipelineBatchByState>), Batches, GetBatches);
%csattribute(Urho3D::OutlinePass, %arg(bool), IsEnabled, IsEnabled, SetEnabled);
%csattribute(Urho3D::OutlinePass, %arg(PostProcessPassFlags), ExecutionFlags, GetExecutionFlags);
%csattribute(Urho3D::OutlinePass, %arg(RenderBuffer *), ColorOutput, GetColorOutput);
%csattribute(Urho3D::SceneProcessor, %arg(SceneProcessorSettings), Settings, GetSettings);
%csattribute(Urho3D::SceneProcessor, %arg(FrameInfo), FrameInfo, GetFrameInfo);
%csattribute(Urho3D::SceneProcessor, %arg(ea::vector<PipelineBatchByState>), LightVolumeBatches, GetLightVolumeBatches);
%csattribute(Urho3D::SceneProcessor, %arg(CameraProcessor *), CameraProcessor, GetCameraProcessor);
%csattribute(Urho3D::SceneProcessor, %arg(PipelineStateBuilder *), PipelineStateBuilder, GetPipelineStateBuilder);
%csattribute(Urho3D::SceneProcessor, %arg(DrawableProcessor *), DrawableProcessor, GetDrawableProcessor);
%csattribute(Urho3D::SceneProcessor, %arg(BatchCompositor *), BatchCompositor, GetBatchCompositor);
%csattribute(Urho3D::SceneProcessor, %arg(BatchRenderer *), BatchRenderer, GetBatchRenderer);
%csattribute(Urho3D::RenderBufferManager, %arg(RenderBuffer *), DepthStencilOutput, GetDepthStencilOutput);
%csattribute(Urho3D::RenderBufferManager, %arg(RenderBuffer *), ColorOutput, GetColorOutput);
%csattribute(Urho3D::RenderBufferManager, %arg(RawTexture *), DepthStencilTexture, GetDepthStencilTexture);
%csattribute(Urho3D::RenderBufferManager, %arg(RawTexture *), SecondaryColorTexture, GetSecondaryColorTexture);
%csattribute(Urho3D::RenderBufferManager, %arg(IntVector2), OutputSize, GetOutputSize);
%csattribute(Urho3D::RenderBufferManager, %arg(Vector2), InvOutputSize, GetInvOutputSize);
%csattribute(Urho3D::RenderBufferManager, %arg(Vector4), DefaultClipToUVSpaceOffsetAndScale, GetDefaultClipToUVSpaceOffsetAndScale);
%csattribute(Urho3D::RenderBufferManager, %arg(TextureFormat), OutputColorFormat, GetOutputColorFormat);
%csattribute(Urho3D::RenderBufferManager, %arg(TextureFormat), OutputDepthStencilFormat, GetOutputDepthStencilFormat);
...
%csattribute(Urho3D::RenderBufferManager, %arg(RenderBufferManagerSettings), Settings, GetSettings, SetSettings);
%csattribute(Urho3D::DefaultRenderPipelineView, %arg(RenderPipelineSettings), Settings, GetSettings, SetSettings);
%csattribute(Urho3D::DefaultRenderPipelineView, %arg(FrameInfo), FrameInfo, GetFrameInfo);
%csattribute(Urho3D::DefaultRenderPipelineView, %arg(RenderPipelineStats), Stats, GetStats);
%csattribute(Urho3D::ShadowSplitProcessor, %arg(LightProcessor *), LightProcessor, GetLightProcessor);
%csattribute(Urho3D::ShadowSplitProcessor, %arg(Light *), Light, GetLight);
...
%csattribute(Urho3D::ShadowSplitProcessor, %arg(ShadowMapRegion), ShadowMap, GetShadowMap);
...
%csattribute(Urho3D::ShadowSplitProcessor, %arg(FloatRange), CascadeZRange, GetCascadeZRange);
%csattribute(Urho3D::ShadowSplitProcessor, %arg(Camera *), ShadowCamera, GetShadowCamera);
...
%csattribute(Urho3D::ShadowSplitProcessor, %arg(PipelineBatchGroup<PipelineBatchByState>), MutableShadowBatches, GetMutableShadowBatches);
%csattribute(Urho3D::ShadowSplitProcessor, %arg(PipelineBatchGroup<PipelineBatchByState>), ShadowBatches, GetShadowBatches);
...
%csattribute(Urho3D::LightProcessor, %arg(Light *), Light, GetLight);
%csattribute(Urho3D::LightProcessor, %arg(ea::vector<Drawable *>), LitGeometries, GetLitGeometries);
%csattribute(Urho3D::LightProcessor, %arg(IntVector2), ShadowMapSize, GetShadowMapSize);
...
%csattribute(Urho3D::LightProcessor, %arg(ShadowMapRegion), ShadowMap, GetShadowMap);
%csattribute(Urho3D::LightProcessor, %arg(CookedLightParams), Params, GetParams);
%csattribute(Urho3D::LightmapRenderPipelineView, %arg(RawTexture *), PositionBuffer, GetPositionBuffer);
%csattribute(Urho3D::LightmapRenderPipelineView, %arg(RawTexture *), SmoothPositionBuffer, GetSmoothPositionBuffer);
%csattribute(Urho3D::LightmapRenderPipelineView, %arg(RawTexture *), FaceNormalBuffer, GetFaceNormalBuffer);
%csattribute(Urho3D::LightmapRenderPipelineView, %arg(RawTexture *), SmoothNormalBuffer, GetSmoothNormalBuffer);
%csattribute(Urho3D::LightmapRenderPipelineView, %arg(RawTexture *), AlbedoBuffer, GetAlbedoBuffer);
%csattribute(Urho3D::LightmapRenderPipelineView, %arg(RawTexture *), EmissionBuffer, GetEmissionBuffer);
%csattribute(Urho3D::ShadowMapAllocator, %arg(ShadowMapAllocatorSettings), Settings, GetSettings, SetSettings);
%csattribute(Urho3D::ShadowMapAllocator, %arg(SamplerStateDesc), SamplerStateDesc, GetSamplerStateDesc);
%csattribute(Urho3D::ShadowMapAllocator, %arg(PipelineStateOutputDesc), ShadowOutputDesc, GetShadowOutputDesc);
%csattribute(Urho3D::StereoRenderPipelineView, %arg(RenderPipelineSettings), Settings, GetSettings, SetSettings);
%csattribute(Urho3D::ToneMappingPass, %arg(PostProcessPassFlags), ExecutionFlags, GetExecutionFlags);
