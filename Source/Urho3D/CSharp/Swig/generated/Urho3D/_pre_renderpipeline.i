%constant eastl::string BloomLuminanceweights = "LuminanceWeights";
%ignore Urho3D::Bloom_LuminanceWeights;
%constant eastl::string BloomThreshold = "Threshold";
%ignore Urho3D::Bloom_Threshold;
%constant eastl::string BloomInputinvsize = "InputInvSize";
%ignore Urho3D::Bloom_InputInvSize;
%constant eastl::string BloomIntensity = "Intensity";
%ignore Urho3D::Bloom_Intensity;
%constant eastl::string FrameDeltatime = "DeltaTime";
%ignore Urho3D::ShaderConsts::Frame_DeltaTime;
%constant eastl::string FrameElapsedtime = "ElapsedTime";
%ignore Urho3D::ShaderConsts::Frame_ElapsedTime;
%constant eastl::string CameraView = "View";
%ignore Urho3D::ShaderConsts::Camera_View;
%constant eastl::string CameraViewinv = "ViewInv";
%ignore Urho3D::ShaderConsts::Camera_ViewInv;
%constant eastl::string CameraViewproj = "ViewProj";
%ignore Urho3D::ShaderConsts::Camera_ViewProj;
%constant eastl::string CameraClipplane = "ClipPlane";
%ignore Urho3D::ShaderConsts::Camera_ClipPlane;
%constant eastl::string CameraCamerapos = "CameraPos";
%ignore Urho3D::ShaderConsts::Camera_CameraPos;
%constant eastl::string CameraNearclip = "NearClip";
%ignore Urho3D::ShaderConsts::Camera_NearClip;
%constant eastl::string CameraFarclip = "FarClip";
%ignore Urho3D::ShaderConsts::Camera_FarClip;
%constant eastl::string CameraDepthmode = "DepthMode";
%ignore Urho3D::ShaderConsts::Camera_DepthMode;
%constant eastl::string CameraFrustumsize = "FrustumSize";
%ignore Urho3D::ShaderConsts::Camera_FrustumSize;
%constant eastl::string CameraGbufferoffsets = "GBufferOffsets";
%ignore Urho3D::ShaderConsts::Camera_GBufferOffsets;
%constant eastl::string CameraDepthreconstruct = "DepthReconstruct";
%ignore Urho3D::ShaderConsts::Camera_DepthReconstruct;
%constant eastl::string CameraGbufferinvsize = "GBufferInvSize";
%ignore Urho3D::ShaderConsts::Camera_GBufferInvSize;
%constant eastl::string CameraAmbientcolor = "AmbientColor";
%ignore Urho3D::ShaderConsts::Camera_AmbientColor;
%constant eastl::string CameraFogparams = "FogParams";
%ignore Urho3D::ShaderConsts::Camera_FogParams;
%constant eastl::string CameraFogcolor = "FogColor";
%ignore Urho3D::ShaderConsts::Camera_FogColor;
%constant eastl::string CameraNormaloffsetscale = "NormalOffsetScale";
%ignore Urho3D::ShaderConsts::Camera_NormalOffsetScale;
%constant eastl::string ZoneCubemapcenter0 = "CubemapCenter0";
%ignore Urho3D::ShaderConsts::Zone_CubemapCenter0;
%constant eastl::string ZoneCubemapcenter1 = "CubemapCenter1";
%ignore Urho3D::ShaderConsts::Zone_CubemapCenter1;
%constant eastl::string ZoneProjectionboxmin0 = "ProjectionBoxMin0";
%ignore Urho3D::ShaderConsts::Zone_ProjectionBoxMin0;
%constant eastl::string ZoneProjectionboxmin1 = "ProjectionBoxMin1";
%ignore Urho3D::ShaderConsts::Zone_ProjectionBoxMin1;
%constant eastl::string ZoneProjectionboxmax0 = "ProjectionBoxMax0";
%ignore Urho3D::ShaderConsts::Zone_ProjectionBoxMax0;
%constant eastl::string ZoneProjectionboxmax1 = "ProjectionBoxMax1";
%ignore Urho3D::ShaderConsts::Zone_ProjectionBoxMax1;
%constant eastl::string ZoneRoughnesstolodfactor0 = "RoughnessToLODFactor0";
%ignore Urho3D::ShaderConsts::Zone_RoughnessToLODFactor0;
%constant eastl::string ZoneRoughnesstolodfactor1 = "RoughnessToLODFactor1";
%ignore Urho3D::ShaderConsts::Zone_RoughnessToLODFactor1;
%constant eastl::string ZoneReflectionblendfactor = "ReflectionBlendFactor";
%ignore Urho3D::ShaderConsts::Zone_ReflectionBlendFactor;
%constant eastl::string LightLightpos = "LightPos";
%ignore Urho3D::ShaderConsts::Light_LightPos;
%constant eastl::string LightLightdir = "LightDir";
%ignore Urho3D::ShaderConsts::Light_LightDir;
%constant eastl::string LightSpotangle = "SpotAngle";
%ignore Urho3D::ShaderConsts::Light_SpotAngle;
%constant eastl::string LightLightshapematrix = "LightShapeMatrix";
%ignore Urho3D::ShaderConsts::Light_LightShapeMatrix;
%constant eastl::string LightVertexlights = "VertexLights";
%ignore Urho3D::ShaderConsts::Light_VertexLights;
%constant eastl::string LightLightmatrices = "LightMatrices";
%ignore Urho3D::ShaderConsts::Light_LightMatrices;
%constant eastl::string LightLightcolor = "LightColor";
%ignore Urho3D::ShaderConsts::Light_LightColor;
%constant eastl::string LightShadowcubeadjust = "ShadowCubeAdjust";
%ignore Urho3D::ShaderConsts::Light_ShadowCubeAdjust;
%constant eastl::string LightShadowcubeuvbias = "ShadowCubeUVBias";
%ignore Urho3D::ShaderConsts::Light_ShadowCubeUVBias;
%constant eastl::string LightShadowdepthfade = "ShadowDepthFade";
%ignore Urho3D::ShaderConsts::Light_ShadowDepthFade;
%constant eastl::string LightShadowintensity = "ShadowIntensity";
%ignore Urho3D::ShaderConsts::Light_ShadowIntensity;
%constant eastl::string LightShadowmapinvsize = "ShadowMapInvSize";
%ignore Urho3D::ShaderConsts::Light_ShadowMapInvSize;
%constant eastl::string LightShadowsplits = "ShadowSplits";
%ignore Urho3D::ShaderConsts::Light_ShadowSplits;
%constant eastl::string LightVsmshadowparams = "VSMShadowParams";
%ignore Urho3D::ShaderConsts::Light_VSMShadowParams;
%constant eastl::string LightLightrad = "LightRad";
%ignore Urho3D::ShaderConsts::Light_LightRad;
%constant eastl::string LightLightlength = "LightLength";
%ignore Urho3D::ShaderConsts::Light_LightLength;
%constant eastl::string MaterialUoffset = "UOffset";
%ignore Urho3D::ShaderConsts::Material_UOffset;
%constant eastl::string MaterialVoffset = "VOffset";
%ignore Urho3D::ShaderConsts::Material_VOffset;
%constant eastl::string MaterialLmoffset = "LMOffset";
%ignore Urho3D::ShaderConsts::Material_LMOffset;
%constant eastl::string MaterialMatdiffcolor = "MatDiffColor";
%ignore Urho3D::ShaderConsts::Material_MatDiffColor;
%constant eastl::string MaterialMatemissivecolor = "MatEmissiveColor";
%ignore Urho3D::ShaderConsts::Material_MatEmissiveColor;
%constant eastl::string MaterialRoughness = "Roughness";
%ignore Urho3D::ShaderConsts::Material_Roughness;
%constant eastl::string MaterialMatenvmapcolor = "MatEnvMapColor";
%ignore Urho3D::ShaderConsts::Material_MatEnvMapColor;
%constant eastl::string MaterialMetallic = "Metallic";
%ignore Urho3D::ShaderConsts::Material_Metallic;
%constant eastl::string MaterialMatspeccolor = "MatSpecColor";
%ignore Urho3D::ShaderConsts::Material_MatSpecColor;
%constant eastl::string MaterialFadeoffsetscale = "FadeOffsetScale";
%ignore Urho3D::ShaderConsts::Material_FadeOffsetScale;
%constant eastl::string MaterialNormalscale = "NormalScale";
%ignore Urho3D::ShaderConsts::Material_NormalScale;
%constant eastl::string MaterialDielectricreflectance = "DielectricReflectance";
%ignore Urho3D::ShaderConsts::Material_DielectricReflectance;
%constant eastl::string CustomOutlinecolor = "OutlineColor";
%ignore Urho3D::ShaderConsts::Custom_OutlineColor;
%constant eastl::string ObjectModel = "Model";
%ignore Urho3D::ShaderConsts::Object_Model;
%constant eastl::string ObjectShar = "SHAr";
%ignore Urho3D::ShaderConsts::Object_SHAr;
%constant eastl::string ObjectShag = "SHAg";
%ignore Urho3D::ShaderConsts::Object_SHAg;
%constant eastl::string ObjectShab = "SHAb";
%ignore Urho3D::ShaderConsts::Object_SHAb;
%constant eastl::string ObjectShbr = "SHBr";
%ignore Urho3D::ShaderConsts::Object_SHBr;
%constant eastl::string ObjectShbg = "SHBg";
%ignore Urho3D::ShaderConsts::Object_SHBg;
%constant eastl::string ObjectShbb = "SHBb";
%ignore Urho3D::ShaderConsts::Object_SHBb;
%constant eastl::string ObjectShc = "SHC";
%ignore Urho3D::ShaderConsts::Object_SHC;
%constant eastl::string ObjectAmbient = "Ambient";
%ignore Urho3D::ShaderConsts::Object_Ambient;
%constant eastl::string ObjectBillboardrot = "BillboardRot";
%ignore Urho3D::ShaderConsts::Object_BillboardRot;
%constant eastl::string ObjectSkinmatrices = "SkinMatrices";
...
%csconstvalue("64") Urho3D::DrawableProcessorPassFlag::BatchCallback;
%csconstvalue("128") Urho3D::DrawableProcessorPassFlag::PipelineStateCallback;
...
%csattribute(Urho3D::AmbientOcclusionPass, %arg(Urho3D::PostProcessPassFlags), ExecutionFlags, GetExecutionFlags);
%csattribute(Urho3D::AmbientOcclusionPass::CachedStates, %arg(bool), IsValid, IsValid);
...
%csattribute(Urho3D::OutlinePass, %arg(Urho3D::PostProcessPassFlags), ExecutionFlags, GetExecutionFlags);
%csattribute(Urho3D::OutlinePass, %arg(Urho3D::RenderBuffer *), ColorOutput, GetColorOutput);
