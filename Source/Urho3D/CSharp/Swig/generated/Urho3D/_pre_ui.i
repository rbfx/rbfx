...
%csattribute(Urho3D::UIElement, %arg(bool), FixedSize, IsFixedSize);
%csattribute(Urho3D::UIElement, %arg(bool), FixedWidth, IsFixedWidth);
%csattribute(Urho3D::UIElement, %arg(bool), FixedHeight, IsFixedHeight);
...
%csattribute(Urho3D::UIElement, %arg(bool), Enabled, IsEnabled, SetEnabled);
%csattribute(Urho3D::UIElement, %arg(bool), EnabledSelf, IsEnabledSelf);
%csattribute(Urho3D::UIElement, %arg(bool), Editable, IsEditable, SetEditable);
%csattribute(Urho3D::UIElement, %arg(bool), Selected, IsSelected, SetSelected);
%csattribute(Urho3D::UIElement, %arg(bool), Visible, IsVisible, SetVisible);
%csattribute(Urho3D::UIElement, %arg(bool), VisibleEffective, IsVisibleEffective);
%csattribute(Urho3D::UIElement, %arg(bool), Hovering, IsHovering, SetHovering);
%csattribute(Urho3D::UIElement, %arg(bool), Internal, IsInternal, SetInternal);
...
%csattribute(Urho3D::UIElement, %arg(ea::vector<SharedPtr<UIElement>>), Children, GetChildren);
%csattribute(Urho3D::UIElement, %arg(Urho3D::UIElement *), Parent, GetParent);
...
%csattribute(Urho3D::UIElement, %arg(bool), ElementEventSender, IsElementEventSender, SetElementEventSender);
...
%csattribute(Urho3D::BorderImage, %arg(bool), Tiled, IsTiled, SetTiled);
...
%csattribute(Urho3D::Button, %arg(bool), Pressed, IsPressed);
%csattribute(Urho3D::CheckBox, %arg(bool), Checked, IsChecked, SetChecked);
...
%csattribute(Urho3D::Font, %arg(bool), SDFFont, IsSDFFont);
...
%csattribute(Urho3D::FontFace, %arg(bool), DataLost, IsDataLost);
...
%csattribute(Urho3D::LineEdit, %arg(bool), CursorMovable, IsCursorMovable, SetCursorMovable);
%csattribute(Urho3D::LineEdit, %arg(bool), TextSelectable, IsTextSelectable, SetTextSelectable);
%csattribute(Urho3D::LineEdit, %arg(bool), TextCopyable, IsTextCopyable, SetTextCopyable);
...
%csattribute(Urho3D::ScrollView, %arg(bool), WheelHandler, IsWheelHandler);
...
%csattribute(Urho3D::Text, %arg(Urho3D::Font *), Font, GetFont);
...
%csattribute(Urho3D::Text3D, %arg(Urho3D::Font *), Font, GetFont);
...
%csattribute(Urho3D::Text3D, %arg(bool), FixedScreenSize, IsFixedScreenSize, SetFixedScreenSize);
...
%csattribute(Urho3D::UI, %arg(Urho3D::IntVector2), CursorPosition, GetCursorPosition);
%csattribute(Urho3D::UI, %arg(Urho3D::UIElement *), FocusElement, GetFocusElement);
...
%csattribute(Urho3D::UI, %arg(bool), NonFocusedMouseWheel, IsNonFocusedMouseWheel, SetNonFocusedMouseWheel);
...
%csattribute(Urho3D::UI, %arg(bool), Dragging, IsDragging);
...
%csattribute(Urho3D::UI, %arg(Urho3D::Texture2D *), RenderTarget, GetRenderTarget);
%csattribute(Urho3D::UI, %arg(bool), Rendered, IsRendered);
...
%csattribute(Urho3D::Window, %arg(bool), Movable, IsMovable, SetMovable);
%csattribute(Urho3D::Window, %arg(bool), Resizable, IsResizable, SetResizable);
...
%csattribute(Urho3D::Window, %arg(bool), Modal, IsModal, SetModal);
