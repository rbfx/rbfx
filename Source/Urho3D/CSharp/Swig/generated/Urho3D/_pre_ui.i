...
%typemap(csattributes) DragAndDropMode "[global::System.Flags]";
using DragAndDropModeFlags = DragAndDropMode;
...
%csattribute(Urho3D::UIElement, %arg(IntVector2), Position, GetPosition, SetPosition);
%csattribute(Urho3D::UIElement, %arg(IntVector2), Size, GetSize, SetSize);
...
%csattribute(Urho3D::UIElement, %arg(IntVector2), MinSize, GetMinSize, SetMinSize);
...
%csattribute(Urho3D::UIElement, %arg(IntVector2), MaxSize, GetMaxSize, SetMaxSize);
...
%csattribute(Urho3D::UIElement, %arg(IntVector2), ChildOffset, GetChildOffset, SetChildOffset);
%csattribute(Urho3D::UIElement, %arg(HorizontalAlignment), HorizontalAlignment, GetHorizontalAlignment);
%csattribute(Urho3D::UIElement, %arg(VerticalAlignment), VerticalAlignment, GetVerticalAlignment);
%csattribute(Urho3D::UIElement, %arg(bool), EnableAnchor, GetEnableAnchor, SetEnableAnchor);
%csattribute(Urho3D::UIElement, %arg(Vector2), MinAnchor, GetMinAnchor, SetMinAnchor);
%csattribute(Urho3D::UIElement, %arg(Vector2), MaxAnchor, GetMaxAnchor, SetMaxAnchor);
%csattribute(Urho3D::UIElement, %arg(IntVector2), MinOffset, GetMinOffset, SetMinOffset);
%csattribute(Urho3D::UIElement, %arg(IntVector2), MaxOffset, GetMaxOffset, SetMaxOffset);
%csattribute(Urho3D::UIElement, %arg(Vector2), Pivot, GetPivot, SetPivot);
%csattribute(Urho3D::UIElement, %arg(IntRect), ClipBorder, GetClipBorder, SetClipBorder);
...
%csattribute(Urho3D::UIElement, %arg(FocusMode), FocusMode, GetFocusMode);
%csattribute(Urho3D::UIElement, %arg(DragAndDropModeFlags), DragDropMode, GetDragDropMode);
%csattribute(Urho3D::UIElement, %arg(ea::string), AppliedStyle, GetAppliedStyle);
%csattribute(Urho3D::UIElement, %arg(LayoutMode), LayoutMode, GetLayoutMode);
%csattribute(Urho3D::UIElement, %arg(int), LayoutSpacing, GetLayoutSpacing, SetLayoutSpacing);
%csattribute(Urho3D::UIElement, %arg(IntRect), LayoutBorder, GetLayoutBorder, SetLayoutBorder);
%csattribute(Urho3D::UIElement, %arg(Vector2), LayoutFlexScale, GetLayoutFlexScale, SetLayoutFlexScale);
%csattribute(Urho3D::UIElement, %arg(UIElement *), Root, GetRoot);
%csattribute(Urho3D::UIElement, %arg(Color), DerivedColor, GetDerivedColor);
%csattribute(Urho3D::UIElement, %arg(StringVariantMap), Vars, GetVars);
%csattribute(Urho3D::UIElement, %arg(StringVector), Tags, GetTags, SetTags);
%csattribute(Urho3D::UIElement, %arg(MouseButtonFlags), DragButtonCombo, GetDragButtonCombo);
%csattribute(Urho3D::UIElement, %arg(unsigned int), DragButtonCount, GetDragButtonCount);
%csattribute(Urho3D::UIElement, %arg(IntRect), CombinedScreenRect, GetCombinedScreenRect);
...
%csattribute(Urho3D::UIElement, %arg(Color), ColorAttr, GetColorAttr);
%csattribute(Urho3D::UIElement, %arg(TraversalMode), TraversalMode, GetTraversalMode);
%csattribute(Urho3D::UIElement, %arg(bool), IsElementEventSender, IsElementEventSender, SetElementEventSender);
%csattribute(Urho3D::UIElement, %arg(IntVector2), EffectiveMinSize, GetEffectiveMinSize);
%csattribute(Urho3D::BorderImage, %arg(Texture *), Texture, GetTexture, SetTexture);
%csattribute(Urho3D::BorderImage, %arg(IntRect), ImageRect, GetImageRect, SetImageRect);
%csattribute(Urho3D::BorderImage, %arg(IntRect), Border, GetBorder, SetBorder);
%csattribute(Urho3D::BorderImage, %arg(IntRect), ImageBorder, GetImageBorder, SetImageBorder);
%csattribute(Urho3D::BorderImage, %arg(IntVector2), HoverOffset, GetHoverOffset, SetHoverOffset);
%csattribute(Urho3D::BorderImage, %arg(IntVector2), DisabledOffset, GetDisabledOffset, SetDisabledOffset);
%csattribute(Urho3D::BorderImage, %arg(BlendMode), BlendMode, GetBlendMode);
%csattribute(Urho3D::BorderImage, %arg(bool), IsTiled, IsTiled, SetTiled);
%csattribute(Urho3D::BorderImage, %arg(Material *), Material, GetMaterial, SetMaterial);
%csattribute(Urho3D::BorderImage, %arg(ResourceRef), TextureAttr, GetTextureAttr, SetTextureAttr);
%csattribute(Urho3D::BorderImage, %arg(ResourceRef), MaterialAttr, GetMaterialAttr, SetMaterialAttr);
...
%csattribute(Urho3D::Cursor, %arg(VariantVector), ShapesAttr, GetShapesAttr, SetShapesAttr);
...
%csattribute(Urho3D::Window, %arg(IntRect), ResizeBorder, GetResizeBorder, SetResizeBorder);
%csattribute(Urho3D::Window, %arg(bool), IsModal, IsModal, SetModal);
%csattribute(Urho3D::Window, %arg(Color), ModalShadeColor, GetModalShadeColor, SetModalShadeColor);
%csattribute(Urho3D::Window, %arg(Color), ModalFrameColor, GetModalFrameColor, SetModalFrameColor);
%csattribute(Urho3D::Window, %arg(IntVector2), ModalFrameSize, GetModalFrameSize, SetModalFrameSize);
%csattribute(Urho3D::Window, %arg(bool), ModalAutoDismiss, GetModalAutoDismiss, SetModalAutoDismiss);
%csattribute(Urho3D::Button, %arg(IntVector2), PressedOffset, GetPressedOffset, SetPressedOffset);
%csattribute(Urho3D::Button, %arg(IntVector2), PressedChildOffset, GetPressedChildOffset, SetPressedChildOffset);
...
%csattribute(Urho3D::CheckBox, %arg(IntVector2), CheckedOffset, GetCheckedOffset, SetCheckedOffset);
%csattribute(Urho3D::Menu, %arg(UIElement *), Popup, GetPopup, SetPopup);
%csattribute(Urho3D::Menu, %arg(IntVector2), PopupOffset, GetPopupOffset, SetPopupOffset);
...
%csattribute(Urho3D::DropDownList, %arg(UIElement *), SelectedItem, GetSelectedItem);
%csattribute(Urho3D::DropDownList, %arg(ListView *), ListView, GetListView);
%csattribute(Urho3D::DropDownList, %arg(UIElement *), Placeholder, GetPlaceholder);
...
%csattribute(Urho3D::FileSelector, %arg(XMLFile *), DefaultStyle, GetDefaultStyle, SetDefaultStyle);
%csattribute(Urho3D::FileSelector, %arg(Window *), Window, GetWindow);
%csattribute(Urho3D::FileSelector, %arg(Text *), TitleText, GetTitleText);
%csattribute(Urho3D::FileSelector, %arg(ListView *), FileList, GetFileList);
%csattribute(Urho3D::FileSelector, %arg(LineEdit *), PathEdit, GetPathEdit);
%csattribute(Urho3D::FileSelector, %arg(LineEdit *), FileNameEdit, GetFileNameEdit);
%csattribute(Urho3D::FileSelector, %arg(DropDownList *), FilterList, GetFilterList);
%csattribute(Urho3D::FileSelector, %arg(Button *), OKButton, GetOKButton);
%csattribute(Urho3D::FileSelector, %arg(Button *), CancelButton, GetCancelButton);
%csattribute(Urho3D::FileSelector, %arg(Button *), CloseButton, GetCloseButton);
...
%csattribute(Urho3D::Font, %arg(FontType), FontType, GetFontType);
%csattribute(Urho3D::Font, %arg(bool), IsSDFFont, IsSDFFont);
%csattribute(Urho3D::Font, %arg(IntVector2), AbsoluteGlyphOffset, GetAbsoluteGlyphOffset, SetAbsoluteGlyphOffset);
%csattribute(Urho3D::Font, %arg(Vector2), ScaledGlyphOffset, GetScaledGlyphOffset, SetScaledGlyphOffset);
...
%csattribute(Urho3D::LineEdit, %arg(Text *), TextElement, GetTextElement);
%csattribute(Urho3D::LineEdit, %arg(BorderImage *), Cursor, GetCursor);
%csattribute(Urho3D::ScrollView, %arg(bool), IsWheelHandler, IsWheelHandler);
%csattribute(Urho3D::ScrollView, %arg(IntVector2), ViewPosition, GetViewPosition, SetViewPosition);
%csattribute(Urho3D::ScrollView, %arg(UIElement *), ContentElement, GetContentElement, SetContentElement);
%csattribute(Urho3D::ScrollView, %arg(ScrollBar *), HorizontalScrollBar, GetHorizontalScrollBar);
%csattribute(Urho3D::ScrollView, %arg(ScrollBar *), VerticalScrollBar, GetVerticalScrollBar);
%csattribute(Urho3D::ScrollView, %arg(BorderImage *), ScrollPanel, GetScrollPanel);
...
%csattribute(Urho3D::ListView, %arg(UIElement *), SelectedItem, GetSelectedItem);
%csattribute(Urho3D::ListView, %arg(ea::vector<UIElement *>), SelectedItems, GetSelectedItems);
%csattribute(Urho3D::ListView, %arg(HighlightMode), HighlightMode, GetHighlightMode);
...
%csattribute(Urho3D::MessageBox, %arg(UIElement *), Window, GetWindow);
%csattribute(Urho3D::UISelectable, %arg(Color), SelectionColor, GetSelectionColor, SetSelectionColor);
%csattribute(Urho3D::UISelectable, %arg(Color), HoverColor, GetHoverColor, SetHoverColor);
%csattribute(Urho3D::Text, %arg(float), FontSize, GetFontSize, SetFontSize);
%csattribute(Urho3D::Text, %arg(HorizontalAlignment), TextAlignment, GetTextAlignment);
...
%csattribute(Urho3D::Text, %arg(TextEffect), TextEffect, GetTextEffect);
%csattribute(Urho3D::Text, %arg(IntVector2), EffectShadowOffset, GetEffectShadowOffset, SetEffectShadowOffset);
...
%csattribute(Urho3D::Text, %arg(Color), EffectColor, GetEffectColor, SetEffectColor);
...
%csattribute(Urho3D::Text, %arg(ResourceRef), FontAttr, GetFontAttr, SetFontAttr);
%csattribute(Urho3D::Text, %arg(ea::string), TextAttr, GetTextAttr, SetTextAttr);
%csattribute(Urho3D::ProgressBar, %arg(Orientation), Orientation, GetOrientation);
...
%csattribute(Urho3D::ProgressBar, %arg(BorderImage *), Knob, GetKnob);
...
%csattribute(Urho3D::ScrollBar, %arg(Orientation), Orientation, GetOrientation);
...
%csattribute(Urho3D::ScrollBar, %arg(Button *), BackButton, GetBackButton);
%csattribute(Urho3D::ScrollBar, %arg(Button *), ForwardButton, GetForwardButton);
%csattribute(Urho3D::ScrollBar, %arg(Slider *), Slider, GetSlider);
%csattribute(Urho3D::Slider, %arg(Orientation), Orientation, GetOrientation);
%csattribute(Urho3D::Slider, %arg(float), Range, GetRange, SetRange);
%csattribute(Urho3D::Slider, %arg(float), Value, GetValue, SetValue);
%csattribute(Urho3D::Slider, %arg(BorderImage *), Knob, GetKnob);
%csattribute(Urho3D::Slider, %arg(float), RepeatRate, GetRepeatRate, SetRepeatRate);
%csattribute(Urho3D::Sprite, %arg(IntVector2), ScreenPosition, GetScreenPosition);
%csattribute(Urho3D::Sprite, %arg(Vector2), Position, GetPosition, SetPosition);
%csattribute(Urho3D::Sprite, %arg(IntVector2), HotSpot, GetHotSpot, SetHotSpot);
%csattribute(Urho3D::Sprite, %arg(Vector2), Scale, GetScale, SetScale);
%csattribute(Urho3D::Sprite, %arg(float), Rotation, GetRotation, SetRotation);
%csattribute(Urho3D::Sprite, %arg(Texture *), Texture, GetTexture, SetTexture);
%csattribute(Urho3D::Sprite, %arg(IntRect), ImageRect, GetImageRect, SetImageRect);
%csattribute(Urho3D::Sprite, %arg(BlendMode), BlendMode, GetBlendMode);
%csattribute(Urho3D::Sprite, %arg(ResourceRef), TextureAttr, GetTextureAttr, SetTextureAttr);
%csattribute(Urho3D::Sprite, %arg(Matrix3x4), TransformMatrix, GetTransformMatrix);
%csattribute(Urho3D::SplashScreen, %arg(Texture *), BackgroundImage, GetBackgroundImage, SetBackgroundImage);
%csattribute(Urho3D::SplashScreen, %arg(Texture *), ForegroundImage, GetForegroundImage, SetForegroundImage);
%csattribute(Urho3D::SplashScreen, %arg(Texture *), ProgressImage, GetProgressImage, SetProgressImage);
%csattribute(Urho3D::SplashScreen, %arg(Color), ProgressColor, GetProgressColor, SetProgressColor);
...
%csattribute(Urho3D::Text3D, %arg(UpdateGeometryType), UpdateGeometryType, GetUpdateGeometryType);
%csattribute(Urho3D::Text3D, %arg(float), FontSize, GetFontSize, SetFontSize);
%csattribute(Urho3D::Text3D, %arg(Material *), Material, GetMaterial, SetMaterial);
%csattribute(Urho3D::Text3D, %arg(ea::string), Text, GetText, SetText);
%csattribute(Urho3D::Text3D, %arg(HorizontalAlignment), TextAlignment, GetTextAlignment);
%csattribute(Urho3D::Text3D, %arg(HorizontalAlignment), HorizontalAlignment, GetHorizontalAlignment);
%csattribute(Urho3D::Text3D, %arg(VerticalAlignment), VerticalAlignment, GetVerticalAlignment);
...
%csattribute(Urho3D::Text3D, %arg(TextEffect), TextEffect, GetTextEffect);
%csattribute(Urho3D::Text3D, %arg(IntVector2), EffectShadowOffset, GetEffectShadowOffset, SetEffectShadowOffset);
...
%csattribute(Urho3D::Text3D, %arg(Color), EffectColor, GetEffectColor, SetEffectColor);
...
%csattribute(Urho3D::Text3D, %arg(FaceCameraMode), FaceCameraMode, GetFaceCameraMode);
%csattribute(Urho3D::Text3D, %arg(ResourceRef), FontAttr, GetFontAttr, SetFontAttr);
%csattribute(Urho3D::Text3D, %arg(ResourceRef), MaterialAttr, GetMaterialAttr, SetMaterialAttr);
%csattribute(Urho3D::Text3D, %arg(ea::string), TextAttr, GetTextAttr, SetTextAttr);
%csattribute(Urho3D::Text3D, %arg(Color), ColorAttr, GetColorAttr);
%csattribute(Urho3D::TextRenderer3D, %arg(float), DefaultFontSize, GetDefaultFontSize, SetDefaultFontSize);
%csattribute(Urho3D::TextRenderer3D, %arg(ResourceRef), DefaultFontAttr, GetDefaultFontAttr, SetDefaultFontAttr);
%csattribute(Urho3D::ToolTip, %arg(float), Delay, GetDelay, SetDelay);
%csattribute(Urho3D::UI, %arg(UIElement *), Root, GetRoot, SetRoot);
%csattribute(Urho3D::UI, %arg(UIElement *), RootModalElement, GetRootModalElement, SetRootModalElement);
%csattribute(Urho3D::UI, %arg(Cursor *), Cursor, GetCursor, SetCursor);
%csattribute(Urho3D::UI, %arg(IntVector2), UICursorPosition, GetUICursorPosition);
%csattribute(Urho3D::UI, %arg(IntVector2), SystemCursorPosition, GetSystemCursorPosition);
%csattribute(Urho3D::UI, %arg(UIElement *), FrontElement, GetFrontElement);
...
%csattribute(Urho3D::UI, %arg(FontHintLevel), FontHintLevel, GetFontHintLevel);
...
%csattribute(Urho3D::UI, %arg(IntVector2), Size, GetSize);
%csattribute(Urho3D::UI, %arg(IntVector2), CustomSize, GetCustomSize, SetCustomSize);
%csattribute(Urho3D::UI, %arg(bool), IsRendered, IsRendered);
%csattribute(Urho3D::UIComponent, %arg(UIElement *), Root, GetRoot);
%csattribute(Urho3D::UIComponent, %arg(Material *), Material, GetMaterial);
%csattribute(Urho3D::UIComponent, %arg(Texture2D *), Texture, GetTexture);
%csattribute(Urho3D::View3D, %arg(unsigned int), Format, GetFormat);
%csattribute(Urho3D::View3D, %arg(bool), AutoUpdate, GetAutoUpdate, SetAutoUpdate);
%csattribute(Urho3D::View3D, %arg(Scene *), Scene, GetScene);
%csattribute(Urho3D::View3D, %arg(Node *), CameraNode, GetCameraNode);
%csattribute(Urho3D::View3D, %arg(Texture2D *), RenderTexture, GetRenderTexture);
%csattribute(Urho3D::View3D, %arg(Texture2D *), DepthTexture, GetDepthTexture);
%csattribute(Urho3D::View3D, %arg(Viewport *), Viewport, GetViewport);
