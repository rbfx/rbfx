...
%csattribute(Urho3D::IKArmSolver, %arg(Vector2), ShoulderWeight, GetShoulderWeight, SetShoulderWeight);
%csattribute(Urho3D::IKArmSolver, %arg(Vector3), BendDirection, GetBendDirection, SetBendDirection);
%csattribute(Urho3D::IKArmSolver, %arg(Vector3), UpDirection, GetUpDirection, SetUpDirection);
%csattribute(Urho3D::IKChainSolver, %arg(StringVector), BoneNames, GetBoneNames, SetBoneNames);
...
%csattribute(Urho3D::IKHeadSolver, %arg(Vector3), EyeDirection, GetEyeDirection, SetEyeDirection);
%csattribute(Urho3D::IKHeadSolver, %arg(Vector3), EyeOffset, GetEyeOffset, SetEyeOffset);
...
%csattribute(Urho3D::IKIdentitySolver, %arg(Quaternion), RotationOffset, GetRotationOffset, SetRotationOffset);
...
%csattribute(Urho3D::IKLegSolver, %arg(Vector2), BaseTiptoe, GetBaseTiptoe, SetBaseTiptoe);
%csattribute(Urho3D::IKLegSolver, %arg(Vector4), GroundTiptoeTweaks, GetGroundTiptoeTweaks, SetGroundTiptoeTweaks);
%csattribute(Urho3D::IKLegSolver, %arg(Vector3), BendDirection, GetBendDirection, SetBendDirection);
...
%csattribute(Urho3D::IKLimbSolver, %arg(Vector3), BendDirection, GetBendDirection, SetBendDirection);
%csattribute(Urho3D::IKSpineSolver, %arg(StringVector), BoneNames, GetBoneNames, SetBoneNames);
...
%csattribute(Urho3D::IKStickTargets, %arg(StringVector), TargetNames, GetTargetNames, SetTargetNames);
...
%csattribute(Urho3D::IKStickTargets, %arg(Vector3), BaseWorldVelocity, GetBaseWorldVelocity, SetBaseWorldVelocity);
%csattribute(Urho3D::IKStickTargets::TargetInfo, %arg(bool), IsEffectivelyInactive, IsEffectivelyInactive);
%csattribute(Urho3D::IKStickTargets::TargetInfo, %arg(Transform), CurrentTransform, GetCurrentTransform);
...
%csattribute(Urho3D::IKSolver, %arg(StringHash), PostUpdateEvent, GetPostUpdateEvent);
