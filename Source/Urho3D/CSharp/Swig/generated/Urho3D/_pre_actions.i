...
%csattribute(Urho3D::Actions::AttributeFromTo, %arg(ea::string), AttributeName, GetAttributeName, SetAttributeName);
%csattribute(Urho3D::Actions::AttributeTo, %arg(Urho3D::Variant), To, GetTo, SetTo);
%csattribute(Urho3D::Actions::AttributeTo, %arg(ea::string), AttributeName, GetAttributeName, SetAttributeName);
...
%csattribute(Urho3D::Actions::ShaderParameterFromTo, %arg(ea::string), Name, GetName, SetName);
