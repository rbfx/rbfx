...
%csattribute(Urho3D::RmlUI, %arg(bool), Rendering, IsRendering, SetRendering);
%csattribute(Urho3D::RmlUI, %arg(bool), InputCaptured, IsInputCaptured);
...
%csattribute(Urho3D::RmlUIComponent, %arg(bool), Open, IsOpen, SetOpen);
