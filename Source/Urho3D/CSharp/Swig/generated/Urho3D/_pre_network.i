...
%csattribute(Urho3D::Connection, %arg(bool), Client, IsClient);
%csattribute(Urho3D::Connection, %arg(bool), Connected, IsConnected);
%csattribute(Urho3D::Connection, %arg(bool), ConnectPending, IsConnectPending, SetConnectPending);
%csattribute(Urho3D::Connection, %arg(bool), SceneLoaded, IsSceneLoaded);
...
%csattribute(Urho3D::HttpRequest, %arg(bool), Open, IsOpen);
...
%csattribute(Urho3D::Network, %arg(bool), ServerRunning, IsServerRunning);
