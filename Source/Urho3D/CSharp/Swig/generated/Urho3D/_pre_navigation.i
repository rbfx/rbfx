...
%csattribute(Urho3D::CrowdManager, %arg(NavigationMesh *), NavigationMesh, GetNavigationMesh, SetNavigationMesh);
%csattribute(Urho3D::CrowdManager, %arg(unsigned int), NumQueryFilterTypes, GetNumQueryFilterTypes);
%csattribute(Urho3D::CrowdManager, %arg(VariantVector), QueryFilterTypesAttr, GetQueryFilterTypesAttr, SetQueryFilterTypesAttr);
%csattribute(Urho3D::CrowdManager, %arg(unsigned int), NumObstacleAvoidanceTypes, GetNumObstacleAvoidanceTypes);
%csattribute(Urho3D::CrowdManager, %arg(VariantVector), ObstacleAvoidanceTypesAttr, GetObstacleAvoidanceTypesAttr, SetObstacleAvoidanceTypesAttr);
%csattribute(Urho3D::CrowdAgent, %arg(CrowdAgentVelocityCallback), VelocityCallback, GetVelocityCallback, SetVelocityCallback);
%csattribute(Urho3D::CrowdAgent, %arg(Vector3), Position, GetPosition);
%csattribute(Urho3D::CrowdAgent, %arg(Vector3), DesiredVelocity, GetDesiredVelocity);
%csattribute(Urho3D::CrowdAgent, %arg(Vector3), ActualVelocity, GetActualVelocity);
%csattribute(Urho3D::CrowdAgent, %arg(Vector3), TargetPosition, GetTargetPosition, SetTargetPosition);
%csattribute(Urho3D::CrowdAgent, %arg(Vector3), TargetVelocity, GetTargetVelocity, SetTargetVelocity);
%csattribute(Urho3D::CrowdAgent, %arg(CrowdAgentRequestedTarget), RequestedTargetType, GetRequestedTargetType);
%csattribute(Urho3D::CrowdAgent, %arg(CrowdAgentState), AgentState, GetAgentState);
%csattribute(Urho3D::CrowdAgent, %arg(CrowdAgentTargetState), TargetState, GetTargetState);
...
%csattribute(Urho3D::CrowdAgent, %arg(NavigationQuality), NavigationQuality, GetNavigationQuality);
%csattribute(Urho3D::CrowdAgent, %arg(NavigationPushiness), NavigationPushiness, GetNavigationPushiness);
...
%csattribute(Urho3D::NavigationMesh, %arg(Vector3), Padding, GetPadding, SetPadding);
%csattribute(Urho3D::NavigationMesh, %arg(bool), IsInitialized, IsInitialized);
%csattribute(Urho3D::NavigationMesh, %arg(BoundingBox), BoundingBox, GetBoundingBox);
%csattribute(Urho3D::NavigationMesh, %arg(BoundingBox), WorldBoundingBox, GetWorldBoundingBox);
%csattribute(Urho3D::NavigationMesh, %arg(IntVector2), NumTiles, GetNumTiles);
%csattribute(Urho3D::NavigationMesh, %arg(NavmeshPartitionType), PartitionType, GetPartitionType);
...
%csattribute(Urho3D::NavArea, %arg(BoundingBox), BoundingBox, GetBoundingBox, SetBoundingBox);
%csattribute(Urho3D::NavArea, %arg(BoundingBox), WorldBoundingBox, GetWorldBoundingBox);
...
%csattribute(Urho3D::OffMeshConnection, %arg(Node *), EndPoint, GetEndPoint, SetEndPoint);
