...
%csattribute(Urho3D::CrowdAgent, %arg(bool), InCrowd, IsInCrowd);
...
%csattribute(Urho3D::NavigationMesh, %arg(bool), Initialized, IsInitialized);
...
%csattribute(Urho3D::Navigable, %arg(bool), Recursive, IsRecursive, SetRecursive);
...
%csattribute(Urho3D::OffMeshConnection, %arg(bool), Bidirectional, IsBidirectional, SetBidirectional);
