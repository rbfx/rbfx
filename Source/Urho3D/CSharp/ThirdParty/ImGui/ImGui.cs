...
namespace ImGui
{
    public static class ui
    {
        ...
        public static bool Begin(string windowTitle) => Begin(windowTitle, WindowFlags.Default);

        public static unsafe bool Begin(string windowTitle, WindowFlags flags)
        {
            return ImGuiNative.igBegin(windowTitle, null, flags);
        }

        public static unsafe bool Begin(string windowTitle, ref bool opened, WindowFlags flags)
        {
        ...
        public static unsafe bool Begin(string windowTitle, ref bool opened, float backgroundAlpha, WindowFlags flags)
        {
            byte openedLocal = opened ? (byte)1 : (byte)0;
        ...
        public static unsafe bool Begin(string windowTitle, ref bool opened, Vector2 startingSize, WindowFlags flags)
        {
            byte openedLocal = opened ? (byte)1 : (byte)0;
        ...
        public static unsafe bool Begin(string windowTitle, ref bool opened, Vector2 startingSize, float backgroundAlpha, WindowFlags flags)
        {
            byte openedLocal = opened ? (byte)1 : (byte)0;
