...
namespace ImGui
{
    public class TextInputBuffer : IDisposable
    {
        ...
        private unsafe void Resize(int newSize)
        {
            ...
            System.Buffer.MemoryCopy(Buffer.ToPointer(), newBuffer.ToPointer(), Length, Length);
        ...
        public string StringValue
        {
            ...
            set
            {
                ...
                else // Fits in current buffer, just copy data in.
                {
                    ...
                    unsafe
                    {
                        System.Buffer.MemoryCopy(tempNativeString.ToPointer(), Buffer.ToPointer(), bytesToCopy, bytesToCopy);
