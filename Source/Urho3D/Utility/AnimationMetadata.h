...
/// Index of the source animation shared by runtime animations split into multiple track groups.
URHO3D_GLOBAL_CONSTANT(ConstString SourceAnimationIndex{"SourceAnimationIndex"});
/// Whitelist of animation tracks to be generated by GenerateWorldSpaceTracksTransformer.
