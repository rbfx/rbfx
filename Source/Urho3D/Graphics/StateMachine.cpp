...
bool StateMachineParameterSource::Get(const ea::string &parameterName, bool *exists) const
{
...
void StateMachineParameterSource::Set(const ea::string &parameterName, bool value)
{
    bool exists = false;
    ...
    {
        i->first->OnParameterDidChangeValue(parameterName, oldValue, value);
    }
}
...
void StateMachine::SetState(const ea::string &state)
{
...
void StateMachine::OnParameterDidChangeValue(const ea::string &parameterName, bool oldValue, bool newValue) 
{
    if (!transition_) 
    {
