...
bool ShaderCompiler::CompileHLSL()
{
    ...
    switch (desc_.type_)
    {
    case VS: profile = "vs_4_0"; break;
    case PS:
        profile = "ps_5_0";
        flags |= D3DCOMPILE_PREFER_FLOW_CONTROL;
        break;
    case GS: profile = "gs_5_0"; break;
    case HS: profile = "hs_5_0"; break;
    case DS: profile = "ds_5_0"; break;
    case CS: profile = "cs_5_0"; break;
    ...
    HRESULT hr = D3DCompile(desc_.sourceCode_.data(), desc_.sourceCode_.length(), desc_.name_.c_str(), nullptr, nullptr,
...
#   define VULKAN 1
    ...
    auto byteCode = GLSLangUtils::HLSLtoSPIRV(ci, GLSLangUtils::SpirvVersion::Vk100, extraDefine, nullptr);
