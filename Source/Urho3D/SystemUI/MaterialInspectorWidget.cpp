...
void MaterialInspectorWidget::ApplyPreviewSettings()
{
    ...
    auto skybox = previewScene_->FindComponent<Skybox>(ComponentSearchFlag::SelfOrChildrenRecursive);
    auto zone = previewScene_->FindComponent<Zone>(ComponentSearchFlag::SelfOrChildrenRecursive);
    ...
    const auto light = previewScene_->FindComponent<Light>(ComponentSearchFlag::SelfOrChildrenRecursive);
...
void MaterialInspectorWidget::RenderPreview()
{
    ...
    const auto model = previewScene_->FindComponent<StaticModel>(ComponentSearchFlag::SelfOrChildrenRecursive);
