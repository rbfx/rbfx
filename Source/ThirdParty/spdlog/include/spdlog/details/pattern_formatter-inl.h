...
SPDLOG_INLINE pattern_formatter::pattern_formatter(eastl::string pattern, pattern_time_type time_type, eastl::string eol)
...
SPDLOG_INLINE pattern_formatter::pattern_formatter(pattern_time_type time_type, eastl::string eol)
    : pattern_("%+")
    , eol_(std::move(eol))
    , pattern_time_type_(time_type)
    , last_log_secs_(0)
...
// Return padding.
SPDLOG_INLINE details::padding_info pattern_formatter::handle_padspec_(eastl::string::const_iterator &it, eastl::string::const_iterator end)
{
...
SPDLOG_INLINE void pattern_formatter::compile_pattern_(const eastl::string &pattern)
{
