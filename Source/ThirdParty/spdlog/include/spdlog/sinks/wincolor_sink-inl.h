...
template<typename ConsoleMutex>
void SPDLOG_INLINE wincolor_sink<ConsoleMutex>::set_pattern(const eastl::string &pattern)
{
    std::lock_guard<mutex_t> lock(mutex_);
...
void SPDLOG_INLINE wincolor_sink<ConsoleMutex>::write_to_file_(const memory_buf_t &formatted)
{
    ...
    do
    {
        ...
        {
            SPDLOG_THROW(spdlog_ex("wincolor_sink: write_to_file_ failed. GetLastError(): " + eastl::to_string(::GetLastError())));
        }
