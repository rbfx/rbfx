...
if(UNIX AND "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel" )
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fasm-blocks" ) # rbfx: removed -std=c++11
endif()

# rbfx: CMake handles C++ standard version.
...
#        SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++11")
#    endif()
#    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.0" AND NOT WEB)
