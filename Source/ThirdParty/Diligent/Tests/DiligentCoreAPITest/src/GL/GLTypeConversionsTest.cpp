...
#define CHECK_PRIMITIVE_TOPOLOGY_ENUM_VALUE(EnumElement, ExpectedValue) static_assert(EnumElement == ExpectedValue, "PrimitiveTopologyToGLTopology function assumes that " #EnumElement " equals " #ExpectedValue ": fix PrimTopologyToGLTopologyMap array and update this assertion.")
    ...
    CHECK_PRIMITIVE_TOPOLOGY_ENUM_VALUE(PRIMITIVE_TOPOLOGY_TRIANGLE_LIST_ADJ,  6);
    CHECK_PRIMITIVE_TOPOLOGY_ENUM_VALUE(PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP_ADJ, 7);
    CHECK_PRIMITIVE_TOPOLOGY_ENUM_VALUE(PRIMITIVE_TOPOLOGY_LINE_LIST_ADJ,      8);
    CHECK_PRIMITIVE_TOPOLOGY_ENUM_VALUE(PRIMITIVE_TOPOLOGY_LINE_STRIP_ADJ,     9);
    static_assert(PRIMITIVE_TOPOLOGY_LINE_STRIP_ADJ + 1 == PRIMITIVE_TOPOLOGY_1_CONTROL_POINT_PATCHLIST,
...
#undef CHECK_PRIMITIVE_TOPOLOGY_ENUM_VALUE
    ...
    EXPECT_EQ(PrimitiveTopologyToGLTopology(PRIMITIVE_TOPOLOGY_TRIANGLE_LIST_ADJ),  GLenum{GL_TRIANGLES_ADJACENCY});
    EXPECT_EQ(PrimitiveTopologyToGLTopology(PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP_ADJ), GLenum{GL_TRIANGLE_STRIP_ADJACENCY});
    EXPECT_EQ(PrimitiveTopologyToGLTopology(PRIMITIVE_TOPOLOGY_LINE_LIST_ADJ),      GLenum{GL_LINES_ADJACENCY});
    EXPECT_EQ(PrimitiveTopologyToGLTopology(PRIMITIVE_TOPOLOGY_LINE_STRIP_ADJ),     GLenum{GL_LINE_STRIP_ADJACENCY});
    // clang-format on
}
