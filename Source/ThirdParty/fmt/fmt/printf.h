...
inline std_basic_string<Char> vsprintf(
...
/**
  ...
  **Example**::
    ...
    std_string message = fmt::sprintf("The answer is %d", 42);
  \endrst
*/
template <typename S, typename... Args,
          typename Char = enable_if_t<internal::is_string<S>::value, char_t<S>>>
inline std_basic_string<Char> sprintf(const S& format, const Args&... args) {
